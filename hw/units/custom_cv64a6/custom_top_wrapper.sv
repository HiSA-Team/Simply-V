...
//    To convert from AXI4+ATOP to plain AXI4, we also optionally instantiate the
//    'axi_riscv_atomics' module, which handles LR/SC and AMO instructions by
//    translating them into standard AXI4 transactions, ensuring proper AXI4 operation
//    support on AXI4-based memory systems.
...
module custom_top_wrapper # (
  ...
  end  : gen_with_atomics
  else begin : gen_direct_axi_map
