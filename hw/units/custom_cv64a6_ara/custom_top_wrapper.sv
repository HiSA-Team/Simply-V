...
module custom_top_wrapper # (
    ...
    //  |         |     ara_wide    /   |             | ara_narrow
    //  |   Ara   |-------------------->| dwidth_conv | ----------->
    //  |_________|   d(32*NrLanes)     |_____________|   d64
    //
    ...
    // Default Ara AXI data width: these are fixed!
    localparam int unsigned AraWideDataWidth = 32 * ARA_NR_LANES;
    localparam int unsigned AraVLEN          = 32 * ARA_NR_LANES;
    // Interconnects
    ...
    // Baseline
    axi_req_t  cva6_axi_req, ara_axi_narrow_req, ara_wide_axi_req;
    axi_resp_t cva6_axi_resp, ara_axi_narrow_resp, ara_wide_axi_resp;
    // Ara wide
    ...
    // Convert from AraWideDataWidth (axi_ara_wide) to LOCAL_AXI_DATA_WIDTH (axi_ara_narrow)
    axi_dw_converter #(
    ...
    // AraNarrow
    // Outputs
    assign ara_narrow_axi_awid      = ara_narrow_axi_req.aw.id;
    assign ara_narrow_axi_awaddr    = ara_narrow_axi_req.aw.addr;
    assign ara_narrow_axi_awlen     = ara_narrow_axi_req.aw.len;
    assign ara_narrow_axi_awsize    = ara_narrow_axi_req.aw.size;
    assign ara_narrow_axi_awburst   = ara_narrow_axi_req.aw.burst;
    assign ara_narrow_axi_awlock    = ara_narrow_axi_req.aw.lock;
    assign ara_narrow_axi_awcache   = ara_narrow_axi_req.aw.cache;
    assign ara_narrow_axi_awprot    = ara_narrow_axi_req.aw.prot;
    assign ara_narrow_axi_awqos     = ara_narrow_axi_req.aw.qos;
    assign ara_narrow_axi_awregion  = ara_narrow_axi_req.aw.region;
    assign ara_narrow_axi_awvalid   = ara_narrow_axi_req.aw_valid;
    assign ara_narrow_axi_wdata     = ara_narrow_axi_req.w.data;
    assign ara_narrow_axi_wstrb     = ara_narrow_axi_req.w.strb;
    assign ara_narrow_axi_wlast     = ara_narrow_axi_req.w.last;
    assign ara_narrow_axi_wvalid    = ara_narrow_axi_req.w_valid;
    assign ara_narrow_axi_bready    = ara_narrow_axi_req.b_ready;
    assign ara_narrow_axi_araddr    = ara_narrow_axi_req.ar.addr;
    assign ara_narrow_axi_arlen     = ara_narrow_axi_req.ar.len;
    assign ara_narrow_axi_arsize    = ara_narrow_axi_req.ar.size;
    assign ara_narrow_axi_arburst   = ara_narrow_axi_req.ar.burst;
    assign ara_narrow_axi_arlock    = ara_narrow_axi_req.ar.lock;
    assign ara_narrow_axi_arcache   = ara_narrow_axi_req.ar.cache;
    assign ara_narrow_axi_arprot    = ara_narrow_axi_req.ar.prot;
    assign ara_narrow_axi_arqos     = ara_narrow_axi_req.ar.qos;
    assign ara_narrow_axi_arregion  = ara_narrow_axi_req.ar.region;
    assign ara_narrow_axi_arvalid   = ara_narrow_axi_req.ar_valid;
    assign ara_narrow_axi_rready    = ara_narrow_axi_req.r_ready;
    assign ara_narrow_axi_arid      = ara_narrow_axi_req.ar.id;
    // Inputs
    assign ara_narrow_axi_resp.aw_ready = ara_narrow_axi_awready;
    assign ara_narrow_axi_resp.w_ready  = ara_narrow_axi_wready;
    assign ara_narrow_axi_resp.b.id     = ara_narrow_axi_bid;
    assign ara_narrow_axi_resp.b.resp   = ara_narrow_axi_bresp;
    assign ara_narrow_axi_resp.b_valid  = ara_narrow_axi_bvalid;
    assign ara_narrow_axi_resp.ar_ready = ara_narrow_axi_arready;
    assign ara_narrow_axi_resp.r.id     = ara_narrow_axi_rid;
    assign ara_narrow_axi_resp.r.data   = ara_narrow_axi_rdata;
    assign ara_narrow_axi_resp.r.resp   = ara_narrow_axi_rresp;
    assign ara_narrow_axi_resp.r.last   = ara_narrow_axi_rlast;
    assign ara_narrow_axi_resp.r_valid  = ara_narrow_axi_rvalid;
