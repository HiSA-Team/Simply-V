...
#              This IP is used for converting the AXI Stream data width from MBUS_DATA_WIDTH bits to 512 bits
...
set_property CONFIG.S_TDATA_NUM_BYTES [expr $::env(MBUS_DATA_WIDTH)/8] [get_ips $::env(IP_NAME)]
