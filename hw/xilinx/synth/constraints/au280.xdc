...
#
set_property PACKAGE_PIN BJ6               [ get_ports  {clk_300mhz_1_n_i} ]             ;# Bank  69 VCCO - VCC1V2 Net "SYSCLK1_N"          - IO_L13N_T2L_N1_GC_QBC_69
set_property IOSTANDARD  LVDS              [ get_ports  {clk_300mhz_1_n_i} ]             ;# Bank  69 VCCO - VCC1V2 Net "SYSCLK1_N"          - IO_L13N_T2L_N1_GC_QBC_69
set_property PACKAGE_PIN BH6               [ get_ports  {clk_300mhz_1_p_i} ]             ;# Bank  69 VCCO - VCC1V2 Net "SYSCLK1_P"          - IO_L13P_T2L_N0_GC_QBC_69
set_property IOSTANDARD  LVDS              [ get_ports  {clk_300mhz_1_p_i} ]             ;# Bank  69 VCCO - VCC1V2 Net "SYSCLK1_P"          - IO_L13P_T2L_N0_GC_QBC_69
#  <<<<NOTE>>>> No external BIAS on AC coupled LVDS clock inputs to 1.2V bank so this constraint is added to recenter LVDS signal on 1.2V IO standard.
set_property DQS_BIAS    TRUE              [ get_ports  {clk_300mhz_1_p_i} ]             ;# Bank  69 VCCO - VCC1V2 Net "SYSCLK1_P"          - IO_L13P_T2L_N0_GC_QBC_69
# #
