...
set src_file_list [ list \
    ...
    $::env(XILINX_ROOT)/rtl/interconnects/mbus_interconnect.svinc       \
    $::env(XILINX_ROOT)/rtl/interconnects/pbus_interconnect.svinc       \
    $::env(XILINX_ROOT)/rtl/interconnects/hbus_interconnect.svinc       \
    $::env(XILINX_ROOT)/rtl/clk_assignments/mbus_clk_assignments.svinc  \
    $::env(XILINX_ROOT)/rtl/clk_assignments/hbus_clk_assignments.svinc  \
