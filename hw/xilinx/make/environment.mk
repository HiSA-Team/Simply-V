...
# Remove the HBUS-only IPs when the HBUS is disabled in the configuration (HBUS_NUM_MI = 0),
# e.g. the HBUS crossbar config.tcl is not generated by the config flow in this case
ifeq ($(strip ${HBUS_NUM_MI}),0)
    FILTER_HBUS_IP := xlnx_highperformance_crossbar xlnx_axi_dwidth_from512_converter
    IP_LIST        := $(filter-out ${FILTER_HBUS_IP},${IP_LIST})
endif
