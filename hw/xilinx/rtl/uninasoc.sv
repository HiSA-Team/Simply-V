...
// TODO: Instantiate the HBM only if board is au280 (or au50)
    hbm_wrapper # (
        .LOCAL_DATA_WIDTH   ( MBUS_DATA_WIDTH ),
        .LOCAL_ADDR_WIDTH   ( MBUS_ADDR_WIDTH ),
        .LOCAL_ID_WIDTH     ( MBUS_ID_WIDTH   )
        ...
        .s_axi_awid     ( MBUS_to_HBM_axi_awid     ),
        .s_axi_awaddr   ( MBUS_to_HBM_axi_awaddr   ),
        .s_axi_awlen    ( MBUS_to_HBM_axi_awlen    ),
        .s_axi_awsize   ( MBUS_to_HBM_axi_awsize   ),
        .s_axi_awburst  ( MBUS_to_HBM_axi_awburst  ),
        .s_axi_awvalid  ( MBUS_to_HBM_axi_awvalid  ),
        .s_axi_awready  ( MBUS_to_HBM_axi_awready  ),
        .s_axi_wdata    ( MBUS_to_HBM_axi_wdata    ),
        .s_axi_wstrb    ( MBUS_to_HBM_axi_wstrb    ),
        .s_axi_wlast    ( MBUS_to_HBM_axi_wlast    ),
        .s_axi_wvalid   ( MBUS_to_HBM_axi_wvalid   ),
        .s_axi_wready   ( MBUS_to_HBM_axi_wready   ),
        .s_axi_bid      ( MBUS_to_HBM_axi_bid      ),
        .s_axi_bresp    ( MBUS_to_HBM_axi_bresp    ),
        .s_axi_bvalid   ( MBUS_to_HBM_axi_bvalid   ),
        .s_axi_bready   ( MBUS_to_HBM_axi_bready   ),
        .s_axi_arid     ( MBUS_to_HBM_axi_arid     ),
        .s_axi_araddr   ( MBUS_to_HBM_axi_araddr   ),
        .s_axi_arlen    ( MBUS_to_HBM_axi_arlen    ),
        .s_axi_arsize   ( MBUS_to_HBM_axi_arsize   ),
        .s_axi_arburst  ( MBUS_to_HBM_axi_arburst  ),
        .s_axi_arvalid  ( MBUS_to_HBM_axi_arvalid  ),
        .s_axi_arready  ( MBUS_to_HBM_axi_arready  ),
        .s_axi_rid      ( MBUS_to_HBM_axi_rid      ),
        .s_axi_rdata    ( MBUS_to_HBM_axi_rdata    ),
        .s_axi_rresp    ( MBUS_to_HBM_axi_rresp    ),
        .s_axi_rlast    ( MBUS_to_HBM_axi_rlast    ),
        .s_axi_rvalid   ( MBUS_to_HBM_axi_rvalid   ),
        .s_axi_rready   ( MBUS_to_HBM_axi_rready   ),
        .s_axi_awlock   ( MBUS_to_HBM_axi_awlock   ),
        .s_axi_awcache  ( MBUS_to_HBM_axi_awcache  ),
        .s_axi_awprot   ( MBUS_to_HBM_axi_awprot   ),
        .s_axi_awqos    ( MBUS_to_HBM_axi_awqos    ),
        .s_axi_awregion ( MBUS_to_HBM_axi_awregion ),
        .s_axi_arlock   ( MBUS_to_HBM_axi_arlock   ),
        .s_axi_arcache  ( MBUS_to_HBM_axi_arcache  ),
        .s_axi_arprot   ( MBUS_to_HBM_axi_arprot   ),
        .s_axi_arqos    ( MBUS_to_HBM_axi_arqos    ),
        .s_axi_arregion ( MBUS_to_HBM_axi_arregion ),
    );
