...
rv_socket #(
    ...
    // INSTRUCTION AXI PORT
    // =======================================================
    .rv_socket_instr_axi_awid      ( RV_SOCKET1_INSTR_to_MBUS_axi_awid     ),
    .rv_socket_instr_axi_awaddr    ( RV_SOCKET1_INSTR_to_MBUS_axi_awaddr   ),
    .rv_socket_instr_axi_awlen     ( RV_SOCKET1_INSTR_to_MBUS_axi_awlen    ),
    .rv_socket_instr_axi_awsize    ( RV_SOCKET1_INSTR_to_MBUS_axi_awsize   ),
    .rv_socket_instr_axi_awburst   ( RV_SOCKET1_INSTR_to_MBUS_axi_awburst  ),
    .rv_socket_instr_axi_awlock    ( RV_SOCKET1_INSTR_to_MBUS_axi_awlock   ),
    .rv_socket_instr_axi_awcache   ( RV_SOCKET1_INSTR_to_MBUS_axi_awcache  ),
    .rv_socket_instr_axi_awprot    ( RV_SOCKET1_INSTR_to_MBUS_axi_awprot   ),
    .rv_socket_instr_axi_awqos     ( RV_SOCKET1_INSTR_to_MBUS_axi_awqos    ),
    .rv_socket_instr_axi_awvalid   ( RV_SOCKET1_INSTR_to_MBUS_axi_awvalid  ),
    .rv_socket_instr_axi_awready   ( RV_SOCKET1_INSTR_to_MBUS_axi_awready  ),
    .rv_socket_instr_axi_awregion  ( RV_SOCKET1_INSTR_to_MBUS_axi_awregion ),
    .rv_socket_instr_axi_wdata     ( RV_SOCKET1_INSTR_to_MBUS_axi_wdata    ),
    .rv_socket_instr_axi_wstrb     ( RV_SOCKET1_INSTR_to_MBUS_axi_wstrb    ),
    .rv_socket_instr_axi_wlast     ( RV_SOCKET1_INSTR_to_MBUS_axi_wlast    ),
    .rv_socket_instr_axi_wvalid    ( RV_SOCKET1_INSTR_to_MBUS_axi_wvalid   ),
    .rv_socket_instr_axi_wready    ( RV_SOCKET1_INSTR_to_MBUS_axi_wready   ),
    .rv_socket_instr_axi_bid       ( RV_SOCKET1_INSTR_to_MBUS_axi_bid      ),
    .rv_socket_instr_axi_bresp     ( RV_SOCKET1_INSTR_to_MBUS_axi_bresp    ),
    .rv_socket_instr_axi_bvalid    ( RV_SOCKET1_INSTR_to_MBUS_axi_bvalid   ),
    .rv_socket_instr_axi_bready    ( RV_SOCKET1_INSTR_to_MBUS_axi_bready   ),
    .rv_socket_instr_axi_arid      ( RV_SOCKET1_INSTR_to_MBUS_axi_arid     ),
    .rv_socket_instr_axi_araddr    ( RV_SOCKET1_INSTR_to_MBUS_axi_araddr   ),
    .rv_socket_instr_axi_arlen     ( RV_SOCKET1_INSTR_to_MBUS_axi_arlen    ),
    .rv_socket_instr_axi_arsize    ( RV_SOCKET1_INSTR_to_MBUS_axi_arsize   ),
    .rv_socket_instr_axi_arburst   ( RV_SOCKET1_INSTR_to_MBUS_axi_arburst  ),
    .rv_socket_instr_axi_arlock    ( RV_SOCKET1_INSTR_to_MBUS_axi_arlock   ),
    .rv_socket_instr_axi_arcache   ( RV_SOCKET1_INSTR_to_MBUS_axi_arcache  ),
    .rv_socket_instr_axi_arprot    ( RV_SOCKET1_INSTR_to_MBUS_axi_arprot   ),
    .rv_socket_instr_axi_arqos     ( RV_SOCKET1_INSTR_to_MBUS_axi_arqos    ),
    .rv_socket_instr_axi_arvalid   ( RV_SOCKET1_INSTR_to_MBUS_axi_arvalid  ),
    .rv_socket_instr_axi_arready   ( RV_SOCKET1_INSTR_to_MBUS_axi_arready  ),
    .rv_socket_instr_axi_arregion  ( RV_SOCKET1_INSTR_to_MBUS_axi_arregion ),
    .rv_socket_instr_axi_rid       ( RV_SOCKET1_INSTR_to_MBUS_axi_rid      ),
    .rv_socket_instr_axi_rdata     ( RV_SOCKET1_INSTR_to_MBUS_axi_rdata    ),
    .rv_socket_instr_axi_rresp     ( RV_SOCKET1_INSTR_to_MBUS_axi_rresp    ),
    .rv_socket_instr_axi_rlast     ( RV_SOCKET1_INSTR_to_MBUS_axi_rlast    ),
    .rv_socket_instr_axi_rvalid    ( RV_SOCKET1_INSTR_to_MBUS_axi_rvalid   ),
    .rv_socket_instr_axi_rready    ( RV_SOCKET1_INSTR_to_MBUS_axi_rready   ),

    // =======================================================
    // DATA AXI PORT
    // =======================================================
    .rv_socket_data_axi_awid      ( RV_SOCKET1_DATA_to_MBUS_axi_awid     ),
    .rv_socket_data_axi_awaddr    ( RV_SOCKET1_DATA_to_MBUS_axi_awaddr   ),
    .rv_socket_data_axi_awlen     ( RV_SOCKET1_DATA_to_MBUS_axi_awlen    ),
    .rv_socket_data_axi_awsize    ( RV_SOCKET1_DATA_to_MBUS_axi_awsize   ),
    .rv_socket_data_axi_awburst   ( RV_SOCKET1_DATA_to_MBUS_axi_awburst  ),
    .rv_socket_data_axi_awlock    ( RV_SOCKET1_DATA_to_MBUS_axi_awlock   ),
    .rv_socket_data_axi_awcache   ( RV_SOCKET1_DATA_to_MBUS_axi_awcache  ),
    .rv_socket_data_axi_awprot    ( RV_SOCKET1_DATA_to_MBUS_axi_awprot   ),
    .rv_socket_data_axi_awqos     ( RV_SOCKET1_DATA_to_MBUS_axi_awqos    ),
    .rv_socket_data_axi_awvalid   ( RV_SOCKET1_DATA_to_MBUS_axi_awvalid  ),
    .rv_socket_data_axi_awready   ( RV_SOCKET1_DATA_to_MBUS_axi_awready  ),
    .rv_socket_data_axi_awregion  ( RV_SOCKET1_DATA_to_MBUS_axi_awregion ),
    .rv_socket_data_axi_wdata     ( RV_SOCKET1_DATA_to_MBUS_axi_wdata    ),
    .rv_socket_data_axi_wstrb     ( RV_SOCKET1_DATA_to_MBUS_axi_wstrb    ),
    .rv_socket_data_axi_wlast     ( RV_SOCKET1_DATA_to_MBUS_axi_wlast    ),
    .rv_socket_data_axi_wvalid    ( RV_SOCKET1_DATA_to_MBUS_axi_wvalid   ),
    .rv_socket_data_axi_wready    ( RV_SOCKET1_DATA_to_MBUS_axi_wready   ),
    .rv_socket_data_axi_bid       ( RV_SOCKET1_DATA_to_MBUS_axi_bid      ),
    .rv_socket_data_axi_bresp     ( RV_SOCKET1_DATA_to_MBUS_axi_bresp    ),
    .rv_socket_data_axi_bvalid    ( RV_SOCKET1_DATA_to_MBUS_axi_bvalid   ),
    .rv_socket_data_axi_bready    ( RV_SOCKET1_DATA_to_MBUS_axi_bready   ),
    .rv_socket_data_axi_arid      ( RV_SOCKET1_DATA_to_MBUS_axi_arid     ),
    .rv_socket_data_axi_araddr    ( RV_SOCKET1_DATA_to_MBUS_axi_araddr   ),
    .rv_socket_data_axi_arlen     ( RV_SOCKET1_DATA_to_MBUS_axi_arlen    ),
    .rv_socket_data_axi_arsize    ( RV_SOCKET1_DATA_to_MBUS_axi_arsize   ),
    .rv_socket_data_axi_arburst   ( RV_SOCKET1_DATA_to_MBUS_axi_arburst  ),
    .rv_socket_data_axi_arlock    ( RV_SOCKET1_DATA_to_MBUS_axi_arlock   ),
    .rv_socket_data_axi_arcache   ( RV_SOCKET1_DATA_to_MBUS_axi_arcache  ),
    .rv_socket_data_axi_arprot    ( RV_SOCKET1_DATA_to_MBUS_axi_arprot   ),
    .rv_socket_data_axi_arqos     ( RV_SOCKET1_DATA_to_MBUS_axi_arqos    ),
    .rv_socket_data_axi_arvalid   ( RV_SOCKET1_DATA_to_MBUS_axi_arvalid  ),
    .rv_socket_data_axi_arready   ( RV_SOCKET1_DATA_to_MBUS_axi_arready  ),
    .rv_socket_data_axi_arregion  ( RV_SOCKET1_DATA_to_MBUS_axi_arregion ),
    .rv_socket_data_axi_rid       ( RV_SOCKET1_DATA_to_MBUS_axi_rid      ),
    .rv_socket_data_axi_rdata     ( RV_SOCKET1_DATA_to_MBUS_axi_rdata    ),
    .rv_socket_data_axi_rresp     ( RV_SOCKET1_DATA_to_MBUS_axi_rresp    ),
    .rv_socket_data_axi_rlast     ( RV_SOCKET1_DATA_to_MBUS_axi_rlast    ),
    .rv_socket_data_axi_rvalid    ( RV_SOCKET1_DATA_to_MBUS_axi_rvalid   ),
    .rv_socket_data_axi_rready    ( RV_SOCKET1_DATA_to_MBUS_axi_rready   ),

    // =======================================================
    // DEBUG AXI INTERFACE (DISABLED FOR SECOND CORE)
    // =======================================================
    .rv_socket_dbg_master_axi_awid        ( ),
    .rv_socket_dbg_master_axi_awaddr      ( ),
    .rv_socket_dbg_master_axi_awlen       ( ),
    .rv_socket_dbg_master_axi_awsize      ( ),
    .rv_socket_dbg_master_axi_awburst     ( ),
    .rv_socket_dbg_master_axi_awlock      ( ),
    .rv_socket_dbg_master_axi_awcache     ( ),
    .rv_socket_dbg_master_axi_awprot      ( ),
    .rv_socket_dbg_master_axi_awqos       ( ),
    .rv_socket_dbg_master_axi_awvalid     ( ),
    .rv_socket_dbg_master_axi_awready     ( ),
    .rv_socket_dbg_master_axi_awregion    ( ),
    .rv_socket_dbg_master_axi_wdata       ( ),
    .rv_socket_dbg_master_axi_wstrb       ( ),
    .rv_socket_dbg_master_axi_wlast       ( ),
    .rv_socket_dbg_master_axi_wvalid      ( ),
    .rv_socket_dbg_master_axi_wready      ( ),
    .rv_socket_dbg_master_axi_bid         ( ),
    .rv_socket_dbg_master_axi_bresp       ( ),
    .rv_socket_dbg_master_axi_bvalid      ( ),
    .rv_socket_dbg_master_axi_bready      ( ),
    .rv_socket_dbg_master_axi_arid        ( ),
    .rv_socket_dbg_master_axi_araddr      ( ),
    .rv_socket_dbg_master_axi_arlen       ( ),
    .rv_socket_dbg_master_axi_arsize      ( ),
    .rv_socket_dbg_master_axi_arburst     ( ),
    .rv_socket_dbg_master_axi_arlock      ( ),
    .rv_socket_dbg_master_axi_arcache     ( ),
    .rv_socket_dbg_master_axi_arprot      ( ),
    .rv_socket_dbg_master_axi_arqos       ( ),
    .rv_socket_dbg_master_axi_arvalid     ( ),
    .rv_socket_dbg_master_axi_arready     ( ),
    .rv_socket_dbg_master_axi_arregion    ( ),
    .rv_socket_dbg_master_axi_rid         ( ),
    .rv_socket_dbg_master_axi_rdata       ( ),
    .rv_socket_dbg_master_axi_rresp       ( ),
    .rv_socket_dbg_master_axi_rlast       ( ),
    .rv_socket_dbg_master_axi_rvalid      ( ),
    .rv_socket_dbg_master_axi_rready      ( ),

    .rv_socket_dbg_slave_axi_awid         ( ),
    .rv_socket_dbg_slave_axi_awaddr       ( ),
    .rv_socket_dbg_slave_axi_awlen        ( ),
    .rv_socket_dbg_slave_axi_awsize       ( ),
    .rv_socket_dbg_slave_axi_awburst      ( ),
    .rv_socket_dbg_slave_axi_awlock       ( ),
    .rv_socket_dbg_slave_axi_awcache      ( ),
    .rv_socket_dbg_slave_axi_awprot       ( ),
    .rv_socket_dbg_slave_axi_awqos        ( ),
    .rv_socket_dbg_slave_axi_awvalid      ( ),
    .rv_socket_dbg_slave_axi_awready      ( ),
    .rv_socket_dbg_slave_axi_awregion     ( ),
    .rv_socket_dbg_slave_axi_wdata        ( ),
    .rv_socket_dbg_slave_axi_wstrb        ( ),
    .rv_socket_dbg_slave_axi_wlast        ( ),
    .rv_socket_dbg_slave_axi_wvalid       ( ),
    .rv_socket_dbg_slave_axi_wready       ( ),
    .rv_socket_dbg_slave_axi_bid          ( ),
    .rv_socket_dbg_slave_axi_bresp        ( ),
    .rv_socket_dbg_slave_axi_bvalid       ( ),
    .rv_socket_dbg_slave_axi_bready       ( ),
    .rv_socket_dbg_slave_axi_arid         ( ),
    .rv_socket_dbg_slave_axi_araddr       ( ),
    .rv_socket_dbg_slave_axi_arlen        ( ),
    .rv_socket_dbg_slave_axi_arsize       ( ),
    .rv_socket_dbg_slave_axi_arburst      ( ),
    .rv_socket_dbg_slave_axi_arlock       ( ),
    .rv_socket_dbg_slave_axi_arcache      ( ),
    .rv_socket_dbg_slave_axi_arprot       ( ),
    .rv_socket_dbg_slave_axi_arqos        ( ),
    .rv_socket_dbg_slave_axi_arvalid      ( ),
    .rv_socket_dbg_slave_axi_arready      ( ),
    .rv_socket_dbg_slave_axi_arregion     ( ),
    .rv_socket_dbg_slave_axi_rid          ( ),
    .rv_socket_dbg_slave_axi_rdata        ( ),
    .rv_socket_dbg_slave_axi_rresp        ( ),
    .rv_socket_dbg_slave_axi_rlast        ( ),
    .rv_socket_dbg_slave_axi_rvalid       ( ),
    .rv_socket_dbg_slave_axi_rready       ( )
);
