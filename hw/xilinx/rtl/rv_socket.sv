...
module rv_socket # (
    ...
    case (CORE_SELECTOR)
        ...
        CORE_CV64A6 : begin: core_cv64a6
            ...
            // Sink instruction port (we only use data port)
            ...
            custom_cv64a6 cv64a6_core (
                ...
                .debug_req_i    ( debug_req_core                ),
                // AXI master
                .m_axi_awaddr   ( cv64a6_axi_awaddr             ),
                .m_axi_awlen    ( cv64a6_axi_awlen              ),
                .m_axi_awsize   ( cv64a6_axi_awsize             ),
                .m_axi_awburst  ( cv64a6_axi_awburst            ),
                .m_axi_awlock   ( cv64a6_axi_awlock             ),
                .m_axi_awcache  ( cv64a6_axi_awcache            ),
                .m_axi_awprot   ( cv64a6_axi_awprot             ),
                .m_axi_awregion ( cv64a6_axi_awregion           ),
                .m_axi_awqos    ( cv64a6_axi_awqos              ),
                .m_axi_awvalid  ( cv64a6_axi_awvalid            ),
                .m_axi_awready  ( cv64a6_axi_awready            ),
                .m_axi_awid     ( cv64a6_axi_awid               ),
                .m_axi_wdata    ( cv64a6_axi_wdata              ),
                .m_axi_wstrb    ( cv64a6_axi_wstrb              ),
                .m_axi_wlast    ( cv64a6_axi_wlast              ),
                .m_axi_wvalid   ( cv64a6_axi_wvalid             ),
                .m_axi_wready   ( cv64a6_axi_wready             ),
                .m_axi_bresp    ( cv64a6_axi_bresp              ),
                .m_axi_bvalid   ( cv64a6_axi_bvalid             ),
                .m_axi_bready   ( cv64a6_axi_bready             ),
                .m_axi_bid      ( cv64a6_axi_bid                ),
                .m_axi_araddr   ( cv64a6_axi_araddr             ),
                .m_axi_arlen    ( cv64a6_axi_arlen              ),
                .m_axi_arsize   ( cv64a6_axi_arsize             ),
                .m_axi_arburst  ( cv64a6_axi_arburst            ),
                .m_axi_arlock   ( cv64a6_axi_arlock             ),
                .m_axi_arcache  ( cv64a6_axi_arcache            ),
                .m_axi_arprot   ( cv64a6_axi_arprot             ),
                .m_axi_arregion ( cv64a6_axi_arregion           ),
                .m_axi_arqos    ( cv64a6_axi_arqos              ),
                .m_axi_arvalid  ( cv64a6_axi_arvalid            ),
                .m_axi_arready  ( cv64a6_axi_arready            ),
                .m_axi_arid     ( cv64a6_axi_arid               ),
                .m_axi_rdata    ( cv64a6_axi_rdata              ),
                .m_axi_rresp    ( cv64a6_axi_rresp              ),
                .m_axi_rlast    ( cv64a6_axi_rlast              ),
                .m_axi_rvalid   ( cv64a6_axi_rvalid             ),
                .m_axi_rready   ( cv64a6_axi_rready             ),
                .m_axi_rid      ( cv64a6_axi_rid                )
            );
        end : core_cv64a6
