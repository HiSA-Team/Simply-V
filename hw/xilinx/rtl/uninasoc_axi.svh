...
// Assign srce to dest signals
`define ASSIGN_AXI_BUS_INDEX_SRC(dest, src, idx) \
    assign ``dest``_axi_awid     = ``src``_axi_awid     [``idx``] ; \
    assign ``dest``_axi_awaddr   = ``src``_axi_awaddr   [``idx``] ; \
    assign ``dest``_axi_awlen    = ``src``_axi_awlen    [``idx``] ; \
    assign ``dest``_axi_awsize   = ``src``_axi_awsize   [``idx``] ; \
    assign ``dest``_axi_awburst  = ``src``_axi_awburst  [``idx``] ; \
    assign ``dest``_axi_awlock   = ``src``_axi_awlock   [``idx``] ; \
    assign ``dest``_axi_awcache  = ``src``_axi_awcache  [``idx``] ; \
    assign ``dest``_axi_awprot   = ``src``_axi_awprot   [``idx``] ; \
    assign ``dest``_axi_awqos    = ``src``_axi_awqos    [``idx``] ; \
    assign ``dest``_axi_awvalid  = ``src``_axi_awvalid  [``idx``] ; \
    assign ``dest``_axi_awregion = ``src``_axi_awregion [``idx``] ; \
    assign ``dest``_axi_wdata    = ``src``_axi_wdata    [``idx``] ; \
    assign ``dest``_axi_wstrb    = ``src``_axi_wstrb    [``idx``] ; \
    assign ``dest``_axi_wlast    = ``src``_axi_wlast    [``idx``] ; \
    assign ``dest``_axi_wvalid   = ``src``_axi_wvalid   [``idx``] ; \
    assign ``dest``_axi_araddr   = ``src``_axi_araddr   [``idx``] ; \
    assign ``dest``_axi_arlen    = ``src``_axi_arlen    [``idx``] ; \
    assign ``dest``_axi_arsize   = ``src``_axi_arsize   [``idx``] ; \
    assign ``dest``_axi_arburst  = ``src``_axi_arburst  [``idx``] ; \
    assign ``dest``_axi_arlock   = ``src``_axi_arlock   [``idx``] ; \
    assign ``dest``_axi_arcache  = ``src``_axi_arcache  [``idx``] ; \
    assign ``dest``_axi_arprot   = ``src``_axi_arprot   [``idx``] ; \
    assign ``dest``_axi_arqos    = ``src``_axi_arqos    [``idx``] ; \
    assign ``dest``_axi_arvalid  = ``src``_axi_arvalid  [``idx``] ; \
    assign ``dest``_axi_arid     = ``src``_axi_arid     [``idx``] ; \
    assign ``dest``_axi_arregion = ``src``_axi_arregion [``idx``] ; \
    assign ``dest``_axi_rready   = ``src``_axi_rready   [``idx``] ; \
    assign ``dest``_axi_bready   = ``src``_axi_bready   [``idx``] ; \
    assign ``src``_axi_awready   = ``dest``_axi_awready [``idx``] ; \
    assign ``src``_axi_wready    = ``dest``_axi_wready  [``idx``] ; \
    assign ``src``_axi_bid       = ``dest``_axi_bid     [``idx``] ; \
    assign ``src``_axi_bresp     = ``dest``_axi_bresp   [``idx``] ; \
    assign ``src``_axi_bvalid    = ``dest``_axi_bvalid  [``idx``] ; \
    assign ``src``_axi_arready   = ``dest``_axi_arready [``idx``] ; \
    assign ``src``_axi_rid       = ``dest``_axi_rid     [``idx``] ; \
    assign ``src``_axi_rdata     = ``dest``_axi_rdata   [``idx``] ; \
    assign ``src``_axi_rresp     = ``dest``_axi_rresp   [``idx``] ; \
    assign ``src``_axi_rlast     = ``dest``_axi_rlast   [``idx``] ; \
    assign ``src``_axi_rvalid    = ``dest``_axi_rvalid  [``idx``] ;

// Assign srce to dest signals
`define ASSIGN_AXI_BUS_INDEX_DST(dest, src, idx) \
    assign ``dest``_axi_awid     [``idx``] = ``src``_axi_awid      ; \
    assign ``dest``_axi_awaddr   [``idx``] = ``src``_axi_awaddr    ; \
    assign ``dest``_axi_awlen    [``idx``] = ``src``_axi_awlen     ; \
    assign ``dest``_axi_awsize   [``idx``] = ``src``_axi_awsize    ; \
    assign ``dest``_axi_awburst  [``idx``] = ``src``_axi_awburst   ; \
    assign ``dest``_axi_awlock   [``idx``] = ``src``_axi_awlock    ; \
    assign ``dest``_axi_awcache  [``idx``] = ``src``_axi_awcache   ; \
    assign ``dest``_axi_awprot   [``idx``] = ``src``_axi_awprot    ; \
    assign ``dest``_axi_awqos    [``idx``] = ``src``_axi_awqos     ; \
    assign ``dest``_axi_awvalid  [``idx``] = ``src``_axi_awvalid   ; \
    assign ``dest``_axi_awregion [``idx``] = ``src``_axi_awregion  ; \
    assign ``dest``_axi_wdata    [``idx``] = ``src``_axi_wdata     ; \
    assign ``dest``_axi_wstrb    [``idx``] = ``src``_axi_wstrb     ; \
    assign ``dest``_axi_wlast    [``idx``] = ``src``_axi_wlast     ; \
    assign ``dest``_axi_wvalid   [``idx``] = ``src``_axi_wvalid    ; \
    assign ``dest``_axi_araddr   [``idx``] = ``src``_axi_araddr    ; \
    assign ``dest``_axi_arlen    [``idx``] = ``src``_axi_arlen     ; \
    assign ``dest``_axi_arsize   [``idx``] = ``src``_axi_arsize    ; \
    assign ``dest``_axi_arburst  [``idx``] = ``src``_axi_arburst   ; \
    assign ``dest``_axi_arlock   [``idx``] = ``src``_axi_arlock    ; \
    assign ``dest``_axi_arcache  [``idx``] = ``src``_axi_arcache   ; \
    assign ``dest``_axi_arprot   [``idx``] = ``src``_axi_arprot    ; \
    assign ``dest``_axi_arqos    [``idx``] = ``src``_axi_arqos     ; \
    assign ``dest``_axi_arvalid  [``idx``] = ``src``_axi_arvalid   ; \
    assign ``dest``_axi_arid     [``idx``] = ``src``_axi_arid      ; \
    assign ``dest``_axi_arregion [``idx``] = ``src``_axi_arregion  ; \
    assign ``dest``_axi_rready   [``idx``] = ``src``_axi_rready    ; \
    assign ``dest``_axi_bready   [``idx``] = ``src``_axi_bready    ; \
    assign ``src``_axi_awready   [``idx``] = ``dest``_axi_awready  ; \
    assign ``src``_axi_wready    [``idx``] = ``dest``_axi_wready   ; \
    assign ``src``_axi_bid       [``idx``] = ``dest``_axi_bid      ; \
    assign ``src``_axi_bresp     [``idx``] = ``dest``_axi_bresp    ; \
    assign ``src``_axi_bvalid    [``idx``] = ``dest``_axi_bvalid   ; \
    assign ``src``_axi_arready   [``idx``] = ``dest``_axi_arready  ; \
    assign ``src``_axi_rid       [``idx``] = ``dest``_axi_rid      ; \
    assign ``src``_axi_rdata     [``idx``] = ``dest``_axi_rdata    ; \
    assign ``src``_axi_rresp     [``idx``] = ``dest``_axi_rresp    ; \
    assign ``src``_axi_rlast     [``idx``] = ``dest``_axi_rlast    ; \
    assign ``src``_axi_rvalid    [``idx``] = ``dest``_axi_rvalid   ;
...
// Concatenate 9 master buses
`define CONCAT_AXI_MASTERS_ARRAY9(array_name, bus_name8, bus_name7, bus_name6, bus_name5, bus_name4, bus_name3, bus_name2, bus_name1, bus_name0) \
    assign ``array_name``_axi_awid     = {``bus_name8``_axi_awid      , ``bus_name7``_axi_awid      , ``bus_name6``_axi_awid      , ``bus_name5``_axi_awid      , ``bus_name4``_axi_awid      , ``bus_name3``_axi_awid      , ``bus_name2``_axi_awid      , ``bus_name1``_axi_awid      , ``bus_name0``_axi_awid     }; \
    assign ``array_name``_axi_awaddr   = {``bus_name8``_axi_awaddr    , ``bus_name7``_axi_awaddr    , ``bus_name6``_axi_awaddr    , ``bus_name5``_axi_awaddr    , ``bus_name4``_axi_awaddr    , ``bus_name3``_axi_awaddr    , ``bus_name2``_axi_awaddr    , ``bus_name1``_axi_awaddr    , ``bus_name0``_axi_awaddr   }; \
    assign ``array_name``_axi_awlen    = {``bus_name8``_axi_awlen     , ``bus_name7``_axi_awlen     , ``bus_name6``_axi_awlen     , ``bus_name5``_axi_awlen     , ``bus_name4``_axi_awlen     , ``bus_name3``_axi_awlen     , ``bus_name2``_axi_awlen     , ``bus_name1``_axi_awlen     , ``bus_name0``_axi_awlen    }; \
    assign ``array_name``_axi_awsize   = {``bus_name8``_axi_awsize    , ``bus_name7``_axi_awsize    , ``bus_name6``_axi_awsize    , ``bus_name5``_axi_awsize    , ``bus_name4``_axi_awsize    , ``bus_name3``_axi_awsize    , ``bus_name2``_axi_awsize    , ``bus_name1``_axi_awsize    , ``bus_name0``_axi_awsize   }; \
    assign ``array_name``_axi_awburst  = {``bus_name8``_axi_awburst   , ``bus_name7``_axi_awburst   , ``bus_name6``_axi_awburst   , ``bus_name5``_axi_awburst   , ``bus_name4``_axi_awburst   , ``bus_name3``_axi_awburst   , ``bus_name2``_axi_awburst   , ``bus_name1``_axi_awburst   , ``bus_name0``_axi_awburst  }; \
    assign ``array_name``_axi_awlock   = {``bus_name8``_axi_awlock    , ``bus_name7``_axi_awlock    , ``bus_name6``_axi_awlock    , ``bus_name5``_axi_awlock    , ``bus_name4``_axi_awlock    , ``bus_name3``_axi_awlock    , ``bus_name2``_axi_awlock    , ``bus_name1``_axi_awlock    , ``bus_name0``_axi_awlock   }; \
    assign ``array_name``_axi_awcache  = {``bus_name8``_axi_awcache   , ``bus_name7``_axi_awcache   , ``bus_name6``_axi_awcache   , ``bus_name5``_axi_awcache   , ``bus_name4``_axi_awcache   , ``bus_name3``_axi_awcache   , ``bus_name2``_axi_awcache   , ``bus_name1``_axi_awcache   , ``bus_name0``_axi_awcache  }; \
    assign ``array_name``_axi_awprot   = {``bus_name8``_axi_awprot    , ``bus_name7``_axi_awprot    , ``bus_name6``_axi_awprot    , ``bus_name5``_axi_awprot    , ``bus_name4``_axi_awprot    , ``bus_name3``_axi_awprot    , ``bus_name2``_axi_awprot    , ``bus_name1``_axi_awprot    , ``bus_name0``_axi_awprot   }; \
    assign ``array_name``_axi_awqos    = {``bus_name8``_axi_awqos     , ``bus_name7``_axi_awqos     , ``bus_name6``_axi_awqos     , ``bus_name5``_axi_awqos     , ``bus_name4``_axi_awqos     , ``bus_name3``_axi_awqos     , ``bus_name2``_axi_awqos     , ``bus_name1``_axi_awqos     , ``bus_name0``_axi_awqos    }; \
    assign ``array_name``_axi_awvalid  = {``bus_name8``_axi_awvalid   , ``bus_name7``_axi_awvalid   , ``bus_name6``_axi_awvalid   , ``bus_name5``_axi_awvalid   , ``bus_name4``_axi_awvalid   , ``bus_name3``_axi_awvalid   , ``bus_name2``_axi_awvalid   , ``bus_name1``_axi_awvalid   , ``bus_name0``_axi_awvalid  }; \
    assign ``array_name``_axi_awregion = {``bus_name8``_axi_awregion  , ``bus_name7``_axi_awregion  , ``bus_name6``_axi_awregion  , ``bus_name5``_axi_awregion  , ``bus_name4``_axi_awregion  , ``bus_name3``_axi_awregion  , ``bus_name2``_axi_awregion  , ``bus_name1``_axi_awregion  , ``bus_name0``_axi_awregion }; \
    assign ``array_name``_axi_wdata    = {``bus_name8``_axi_wdata     , ``bus_name7``_axi_wdata     , ``bus_name6``_axi_wdata     , ``bus_name5``_axi_wdata     , ``bus_name4``_axi_wdata     , ``bus_name3``_axi_wdata     , ``bus_name2``_axi_wdata     , ``bus_name1``_axi_wdata     , ``bus_name0``_axi_wdata    }; \
    assign ``array_name``_axi_wstrb    = {``bus_name8``_axi_wstrb     , ``bus_name7``_axi_wstrb     , ``bus_name6``_axi_wstrb     , ``bus_name5``_axi_wstrb     , ``bus_name4``_axi_wstrb     , ``bus_name3``_axi_wstrb     , ``bus_name2``_axi_wstrb     , ``bus_name1``_axi_wstrb     , ``bus_name0``_axi_wstrb    }; \
    assign ``array_name``_axi_wlast    = {``bus_name8``_axi_wlast     , ``bus_name7``_axi_wlast     , ``bus_name6``_axi_wlast     , ``bus_name5``_axi_wlast     , ``bus_name4``_axi_wlast     , ``bus_name3``_axi_wlast     , ``bus_name2``_axi_wlast     , ``bus_name1``_axi_wlast     , ``bus_name0``_axi_wlast    }; \
    assign ``array_name``_axi_wvalid   = {``bus_name8``_axi_wvalid    , ``bus_name7``_axi_wvalid    , ``bus_name6``_axi_wvalid    , ``bus_name5``_axi_wvalid    , ``bus_name4``_axi_wvalid    , ``bus_name3``_axi_wvalid    , ``bus_name2``_axi_wvalid    , ``bus_name1``_axi_wvalid    , ``bus_name0``_axi_wvalid   }; \
    assign ``array_name``_axi_bready   = {``bus_name8``_axi_bready    , ``bus_name7``_axi_bready    , ``bus_name6``_axi_bready    , ``bus_name5``_axi_bready    , ``bus_name4``_axi_bready    , ``bus_name3``_axi_bready    , ``bus_name2``_axi_bready    , ``bus_name1``_axi_bready    , ``bus_name0``_axi_bready   }; \
    assign ``array_name``_axi_araddr   = {``bus_name8``_axi_araddr    , ``bus_name7``_axi_araddr    , ``bus_name6``_axi_araddr    , ``bus_name5``_axi_araddr    , ``bus_name4``_axi_araddr    , ``bus_name3``_axi_araddr    , ``bus_name2``_axi_araddr    , ``bus_name1``_axi_araddr    , ``bus_name0``_axi_araddr   }; \
    assign ``array_name``_axi_arlen    = {``bus_name8``_axi_arlen     , ``bus_name7``_axi_arlen     , ``bus_name6``_axi_arlen     , ``bus_name5``_axi_arlen     , ``bus_name4``_axi_arlen     , ``bus_name3``_axi_arlen     , ``bus_name2``_axi_arlen     , ``bus_name1``_axi_arlen     , ``bus_name0``_axi_arlen    }; \
    assign ``array_name``_axi_arsize   = {``bus_name8``_axi_arsize    , ``bus_name7``_axi_arsize    , ``bus_name6``_axi_arsize    , ``bus_name5``_axi_arsize    , ``bus_name4``_axi_arsize    , ``bus_name3``_axi_arsize    , ``bus_name2``_axi_arsize    , ``bus_name1``_axi_arsize    , ``bus_name0``_axi_arsize   }; \
    assign ``array_name``_axi_arburst  = {``bus_name8``_axi_arburst   , ``bus_name7``_axi_arburst   , ``bus_name6``_axi_arburst   , ``bus_name5``_axi_arburst   , ``bus_name4``_axi_arburst   , ``bus_name3``_axi_arburst   , ``bus_name2``_axi_arburst   , ``bus_name1``_axi_arburst   , ``bus_name0``_axi_arburst  }; \
    assign ``array_name``_axi_arlock   = {``bus_name8``_axi_arlock    , ``bus_name7``_axi_arlock    , ``bus_name6``_axi_arlock    , ``bus_name5``_axi_arlock    , ``bus_name4``_axi_arlock    , ``bus_name3``_axi_arlock    , ``bus_name2``_axi_arlock    , ``bus_name1``_axi_arlock    , ``bus_name0``_axi_arlock   }; \
    assign ``array_name``_axi_arcache  = {``bus_name8``_axi_arcache   , ``bus_name7``_axi_arcache   , ``bus_name6``_axi_arcache   , ``bus_name5``_axi_arcache   , ``bus_name4``_axi_arcache   , ``bus_name3``_axi_arcache   , ``bus_name2``_axi_arcache   , ``bus_name1``_axi_arcache   , ``bus_name0``_axi_arcache  }; \
    assign ``array_name``_axi_arprot   = {``bus_name8``_axi_arprot    , ``bus_name7``_axi_arprot    , ``bus_name6``_axi_arprot    , ``bus_name5``_axi_arprot    , ``bus_name4``_axi_arprot    , ``bus_name3``_axi_arprot    , ``bus_name2``_axi_arprot    , ``bus_name1``_axi_arprot    , ``bus_name0``_axi_arprot   }; \
    assign ``array_name``_axi_arqos    = {``bus_name8``_axi_arqos     , ``bus_name7``_axi_arqos     , ``bus_name6``_axi_arqos     , ``bus_name5``_axi_arqos     , ``bus_name4``_axi_arqos     , ``bus_name3``_axi_arqos     , ``bus_name2``_axi_arqos     , ``bus_name1``_axi_arqos     , ``bus_name0``_axi_arqos    }; \
    assign ``array_name``_axi_arvalid  = {``bus_name8``_axi_arvalid   , ``bus_name7``_axi_arvalid   , ``bus_name6``_axi_arvalid   , ``bus_name5``_axi_arvalid   , ``bus_name4``_axi_arvalid   , ``bus_name3``_axi_arvalid   , ``bus_name2``_axi_arvalid   , ``bus_name1``_axi_arvalid   , ``bus_name0``_axi_arvalid  }; \
    assign ``array_name``_axi_arid     = {``bus_name8``_axi_arid      , ``bus_name7``_axi_arid      , ``bus_name6``_axi_arid      , ``bus_name5``_axi_arid      , ``bus_name4``_axi_arid      , ``bus_name3``_axi_arid      , ``bus_name2``_axi_arid      , ``bus_name1``_axi_arid      , ``bus_name0``_axi_arid     }; \
    assign ``array_name``_axi_arregion = {``bus_name8``_axi_arregion  , ``bus_name7``_axi_arregion  , ``bus_name6``_axi_arregion  , ``bus_name5``_axi_arregion  , ``bus_name4``_axi_arregion  , ``bus_name3``_axi_arregion  , ``bus_name2``_axi_arregion  , ``bus_name1``_axi_arregion  , ``bus_name0``_axi_arregion }; \
    assign ``array_name``_axi_rready   = {``bus_name8``_axi_rready    , ``bus_name7``_axi_rready    , ``bus_name6``_axi_rready    , ``bus_name5``_axi_rready    , ``bus_name4``_axi_rready    , ``bus_name3``_axi_rready    , ``bus_name2``_axi_rready    , ``bus_name1``_axi_rready    , ``bus_name0``_axi_rready   }; \
    assign {``bus_name8``_axi_awready    , ``bus_name7``_axi_awready    , ``bus_name6``_axi_awready    , ``bus_name5``_axi_awready   , ``bus_name4``_axi_awready   , ``bus_name3``_axi_awready   , ``bus_name2``_axi_awready   , ``bus_name1``_axi_awready   , ``bus_name0``_axi_awready  } = ``array_name``_axi_awready ; \
    assign {``bus_name8``_axi_wready     , ``bus_name7``_axi_wready     , ``bus_name6``_axi_wready     , ``bus_name5``_axi_wready    , ``bus_name4``_axi_wready    , ``bus_name3``_axi_wready    , ``bus_name2``_axi_wready    , ``bus_name1``_axi_wready    , ``bus_name0``_axi_wready   } = ``array_name``_axi_wready  ; \
    assign {``bus_name8``_axi_bid        , ``bus_name7``_axi_bid        , ``bus_name6``_axi_bid        , ``bus_name5``_axi_bid       , ``bus_name4``_axi_bid       , ``bus_name3``_axi_bid       , ``bus_name2``_axi_bid       , ``bus_name1``_axi_bid       , ``bus_name0``_axi_bid      } = ``array_name``_axi_bid     ; \
    assign {``bus_name8``_axi_bresp      , ``bus_name7``_axi_bresp      , ``bus_name6``_axi_bresp      , ``bus_name5``_axi_bresp     , ``bus_name4``_axi_bresp     , ``bus_name3``_axi_bresp     , ``bus_name2``_axi_bresp     , ``bus_name1``_axi_bresp     , ``bus_name0``_axi_bresp    } = ``array_name``_axi_bresp   ; \
    assign {``bus_name8``_axi_bvalid     , ``bus_name7``_axi_bvalid     , ``bus_name6``_axi_bvalid     , ``bus_name5``_axi_bvalid    , ``bus_name4``_axi_bvalid    , ``bus_name3``_axi_bvalid    , ``bus_name2``_axi_bvalid    , ``bus_name1``_axi_bvalid    , ``bus_name0``_axi_bvalid   } = ``array_name``_axi_bvalid  ; \
    assign {``bus_name8``_axi_arready    , ``bus_name7``_axi_arready    , ``bus_name6``_axi_arready    , ``bus_name5``_axi_arready   , ``bus_name4``_axi_arready   , ``bus_name3``_axi_arready   , ``bus_name2``_axi_arready   , ``bus_name1``_axi_arready   , ``bus_name0``_axi_arready  } = ``array_name``_axi_arready ; \
    assign {``bus_name8``_axi_rid        , ``bus_name7``_axi_rid        , ``bus_name6``_axi_rid        , ``bus_name5``_axi_rid       , ``bus_name4``_axi_rid       , ``bus_name3``_axi_rid       , ``bus_name2``_axi_rid       , ``bus_name1``_axi_rid       , ``bus_name0``_axi_rid      } = ``array_name``_axi_rid     ; \
    assign {``bus_name8``_axi_rdata      , ``bus_name7``_axi_rdata      , ``bus_name6``_axi_rdata      , ``bus_name5``_axi_rdata     , ``bus_name4``_axi_rdata     , ``bus_name3``_axi_rdata     , ``bus_name2``_axi_rdata     , ``bus_name1``_axi_rdata     , ``bus_name0``_axi_rdata    } = ``array_name``_axi_rdata   ; \
    assign {``bus_name8``_axi_rresp      , ``bus_name7``_axi_rresp      , ``bus_name6``_axi_rresp      , ``bus_name5``_axi_rresp     , ``bus_name4``_axi_rresp     , ``bus_name3``_axi_rresp     , ``bus_name2``_axi_rresp     , ``bus_name1``_axi_rresp     , ``bus_name0``_axi_rresp    } = ``array_name``_axi_rresp   ; \
    assign {``bus_name8``_axi_rlast      , ``bus_name7``_axi_rlast      , ``bus_name6``_axi_rlast      , ``bus_name5``_axi_rlast     , ``bus_name4``_axi_rlast     , ``bus_name3``_axi_rlast     , ``bus_name2``_axi_rlast     , ``bus_name1``_axi_rlast     , ``bus_name0``_axi_rlast    } = ``array_name``_axi_rlast   ; \
    assign {``bus_name8``_axi_rvalid     , ``bus_name7``_axi_rvalid     , ``bus_name6``_axi_rvalid     , ``bus_name5``_axi_rvalid    , ``bus_name4``_axi_rvalid    , ``bus_name3``_axi_rvalid    , ``bus_name2``_axi_rvalid    , ``bus_name1``_axi_rvalid    , ``bus_name0``_axi_rvalid   } = ``array_name``_axi_rvalid  ;
...
// Concatenate 11 slave buses
`define CONCAT_AXI_MASTERS_ARRAY11(array_name, bus_name10, bus_name9, bus_name8, bus_name7, bus_name6, bus_name5, bus_name4, bus_name3, bus_name2, bus_name1, bus_name0) \
    assign ``array_name``_axi_awid     = {``bus_name10``_axi_awid      , ``bus_name9``_axi_awid      , ``bus_name8``_axi_awid      , ``bus_name7``_axi_awid      , ``bus_name6``_axi_awid      , ``bus_name5``_axi_awid      , ``bus_name4``_axi_awid      , ``bus_name3``_axi_awid      , ``bus_name2``_axi_awid      , ``bus_name1``_axi_awid      , ``bus_name0``_axi_awid     }; \
    assign ``array_name``_axi_awaddr   = {``bus_name10``_axi_awaddr    , ``bus_name9``_axi_awaddr    , ``bus_name8``_axi_awaddr    , ``bus_name7``_axi_awaddr    , ``bus_name6``_axi_awaddr    , ``bus_name5``_axi_awaddr    , ``bus_name4``_axi_awaddr    , ``bus_name3``_axi_awaddr    , ``bus_name2``_axi_awaddr    , ``bus_name1``_axi_awaddr    , ``bus_name0``_axi_awaddr   }; \
    assign ``array_name``_axi_awlen    = {``bus_name10``_axi_awlen     , ``bus_name9``_axi_awlen     , ``bus_name8``_axi_awlen     , ``bus_name7``_axi_awlen     , ``bus_name6``_axi_awlen     , ``bus_name5``_axi_awlen     , ``bus_name4``_axi_awlen     , ``bus_name3``_axi_awlen     , ``bus_name2``_axi_awlen     , ``bus_name1``_axi_awlen     , ``bus_name0``_axi_awlen    }; \
    assign ``array_name``_axi_awsize   = {``bus_name10``_axi_awsize    , ``bus_name9``_axi_awsize    , ``bus_name8``_axi_awsize    , ``bus_name7``_axi_awsize    , ``bus_name6``_axi_awsize    , ``bus_name5``_axi_awsize    , ``bus_name4``_axi_awsize    , ``bus_name3``_axi_awsize    , ``bus_name2``_axi_awsize    , ``bus_name1``_axi_awsize    , ``bus_name0``_axi_awsize   }; \
    assign ``array_name``_axi_awburst  = {``bus_name10``_axi_awburst   , ``bus_name9``_axi_awburst   , ``bus_name8``_axi_awburst   , ``bus_name7``_axi_awburst   , ``bus_name6``_axi_awburst   , ``bus_name5``_axi_awburst   , ``bus_name4``_axi_awburst   , ``bus_name3``_axi_awburst   , ``bus_name2``_axi_awburst   , ``bus_name1``_axi_awburst   , ``bus_name0``_axi_awburst  }; \
    assign ``array_name``_axi_awlock   = {``bus_name10``_axi_awlock    , ``bus_name9``_axi_awlock    , ``bus_name8``_axi_awlock    , ``bus_name7``_axi_awlock    , ``bus_name6``_axi_awlock    , ``bus_name5``_axi_awlock    , ``bus_name4``_axi_awlock    , ``bus_name3``_axi_awlock    , ``bus_name2``_axi_awlock    , ``bus_name1``_axi_awlock    , ``bus_name0``_axi_awlock   }; \
    assign ``array_name``_axi_awcache  = {``bus_name10``_axi_awcache   , ``bus_name9``_axi_awcache   , ``bus_name8``_axi_awcache   , ``bus_name7``_axi_awcache   , ``bus_name6``_axi_awcache   , ``bus_name5``_axi_awcache   , ``bus_name4``_axi_awcache   , ``bus_name3``_axi_awcache   , ``bus_name2``_axi_awcache   , ``bus_name1``_axi_awcache   , ``bus_name0``_axi_awcache  }; \
    assign ``array_name``_axi_awprot   = {``bus_name10``_axi_awprot    , ``bus_name9``_axi_awprot    , ``bus_name8``_axi_awprot    , ``bus_name7``_axi_awprot    , ``bus_name6``_axi_awprot    , ``bus_name5``_axi_awprot    , ``bus_name4``_axi_awprot    , ``bus_name3``_axi_awprot    , ``bus_name2``_axi_awprot    , ``bus_name1``_axi_awprot    , ``bus_name0``_axi_awprot   }; \
    assign ``array_name``_axi_awqos    = {``bus_name10``_axi_awqos     , ``bus_name9``_axi_awqos     , ``bus_name8``_axi_awqos     , ``bus_name7``_axi_awqos     , ``bus_name6``_axi_awqos     , ``bus_name5``_axi_awqos     , ``bus_name4``_axi_awqos     , ``bus_name3``_axi_awqos     , ``bus_name2``_axi_awqos     , ``bus_name1``_axi_awqos     , ``bus_name0``_axi_awqos    }; \
    assign ``array_name``_axi_awvalid  = {``bus_name10``_axi_awvalid   , ``bus_name9``_axi_awvalid   , ``bus_name8``_axi_awvalid   , ``bus_name7``_axi_awvalid   , ``bus_name6``_axi_awvalid   , ``bus_name5``_axi_awvalid   , ``bus_name4``_axi_awvalid   , ``bus_name3``_axi_awvalid   , ``bus_name2``_axi_awvalid   , ``bus_name1``_axi_awvalid   , ``bus_name0``_axi_awvalid  }; \
    assign ``array_name``_axi_awregion = {``bus_name10``_axi_awregion  , ``bus_name9``_axi_awregion  , ``bus_name8``_axi_awregion  , ``bus_name7``_axi_awregion  , ``bus_name6``_axi_awregion  , ``bus_name5``_axi_awregion  , ``bus_name4``_axi_awregion  , ``bus_name3``_axi_awregion  , ``bus_name2``_axi_awregion  , ``bus_name1``_axi_awregion  , ``bus_name0``_axi_awregion }; \
    assign ``array_name``_axi_wdata    = {``bus_name10``_axi_wdata     , ``bus_name9``_axi_wdata     , ``bus_name8``_axi_wdata     , ``bus_name7``_axi_wdata     , ``bus_name6``_axi_wdata     , ``bus_name5``_axi_wdata     , ``bus_name4``_axi_wdata     , ``bus_name3``_axi_wdata     , ``bus_name2``_axi_wdata     , ``bus_name1``_axi_wdata     , ``bus_name0``_axi_wdata    }; \
    assign ``array_name``_axi_wstrb    = {``bus_name10``_axi_wstrb     , ``bus_name9``_axi_wstrb     , ``bus_name8``_axi_wstrb     , ``bus_name7``_axi_wstrb     , ``bus_name6``_axi_wstrb     , ``bus_name5``_axi_wstrb     , ``bus_name4``_axi_wstrb     , ``bus_name3``_axi_wstrb     , ``bus_name2``_axi_wstrb     , ``bus_name1``_axi_wstrb     , ``bus_name0``_axi_wstrb    }; \
    assign ``array_name``_axi_wlast    = {``bus_name10``_axi_wlast     , ``bus_name9``_axi_wlast     , ``bus_name8``_axi_wlast     , ``bus_name7``_axi_wlast     , ``bus_name6``_axi_wlast     , ``bus_name5``_axi_wlast     , ``bus_name4``_axi_wlast     , ``bus_name3``_axi_wlast     , ``bus_name2``_axi_wlast     , ``bus_name1``_axi_wlast     , ``bus_name0``_axi_wlast    }; \
    assign ``array_name``_axi_wvalid   = {``bus_name10``_axi_wvalid    , ``bus_name9``_axi_wvalid    , ``bus_name8``_axi_wvalid    , ``bus_name7``_axi_wvalid    , ``bus_name6``_axi_wvalid    , ``bus_name5``_axi_wvalid    , ``bus_name4``_axi_wvalid    , ``bus_name3``_axi_wvalid    , ``bus_name2``_axi_wvalid    , ``bus_name1``_axi_wvalid    , ``bus_name0``_axi_wvalid   }; \
    assign ``array_name``_axi_bready   = {``bus_name10``_axi_bready    , ``bus_name9``_axi_bready    , ``bus_name8``_axi_bready    , ``bus_name7``_axi_bready    , ``bus_name6``_axi_bready    , ``bus_name5``_axi_bready    , ``bus_name4``_axi_bready    , ``bus_name3``_axi_bready    , ``bus_name2``_axi_bready    , ``bus_name1``_axi_bready    , ``bus_name0``_axi_bready   }; \
    assign ``array_name``_axi_araddr   = {``bus_name10``_axi_araddr    , ``bus_name9``_axi_araddr    , ``bus_name8``_axi_araddr    , ``bus_name7``_axi_araddr    , ``bus_name6``_axi_araddr    , ``bus_name5``_axi_araddr    , ``bus_name4``_axi_araddr    , ``bus_name3``_axi_araddr    , ``bus_name2``_axi_araddr    , ``bus_name1``_axi_araddr    , ``bus_name0``_axi_araddr   }; \
    assign ``array_name``_axi_arlen    = {``bus_name10``_axi_arlen     , ``bus_name9``_axi_arlen     , ``bus_name8``_axi_arlen     , ``bus_name7``_axi_arlen     , ``bus_name6``_axi_arlen     , ``bus_name5``_axi_arlen     , ``bus_name4``_axi_arlen     , ``bus_name3``_axi_arlen     , ``bus_name2``_axi_arlen     , ``bus_name1``_axi_arlen     , ``bus_name0``_axi_arlen    }; \
    assign ``array_name``_axi_arsize   = {``bus_name10``_axi_arsize    , ``bus_name9``_axi_arsize    , ``bus_name8``_axi_arsize    , ``bus_name7``_axi_arsize    , ``bus_name6``_axi_arsize    , ``bus_name5``_axi_arsize    , ``bus_name4``_axi_arsize    , ``bus_name3``_axi_arsize    , ``bus_name2``_axi_arsize    , ``bus_name1``_axi_arsize    , ``bus_name0``_axi_arsize   }; \
    assign ``array_name``_axi_arburst  = {``bus_name10``_axi_arburst   , ``bus_name9``_axi_arburst   , ``bus_name8``_axi_arburst   , ``bus_name7``_axi_arburst   , ``bus_name6``_axi_arburst   , ``bus_name5``_axi_arburst   , ``bus_name4``_axi_arburst   , ``bus_name3``_axi_arburst   , ``bus_name2``_axi_arburst   , ``bus_name1``_axi_arburst   , ``bus_name0``_axi_arburst  }; \
    assign ``array_name``_axi_arlock   = {``bus_name10``_axi_arlock    , ``bus_name9``_axi_arlock    , ``bus_name8``_axi_arlock    , ``bus_name7``_axi_arlock    , ``bus_name6``_axi_arlock    , ``bus_name5``_axi_arlock    , ``bus_name4``_axi_arlock    , ``bus_name3``_axi_arlock    , ``bus_name2``_axi_arlock    , ``bus_name1``_axi_arlock    , ``bus_name0``_axi_arlock   }; \
    assign ``array_name``_axi_arcache  = {``bus_name10``_axi_arcache   , ``bus_name9``_axi_arcache   , ``bus_name8``_axi_arcache   , ``bus_name7``_axi_arcache   , ``bus_name6``_axi_arcache   , ``bus_name5``_axi_arcache   , ``bus_name4``_axi_arcache   , ``bus_name3``_axi_arcache   , ``bus_name2``_axi_arcache   , ``bus_name1``_axi_arcache   , ``bus_name0``_axi_arcache  }; \
    assign ``array_name``_axi_arprot   = {``bus_name10``_axi_arprot    , ``bus_name9``_axi_arprot    , ``bus_name8``_axi_arprot    , ``bus_name7``_axi_arprot    , ``bus_name6``_axi_arprot    , ``bus_name5``_axi_arprot    , ``bus_name4``_axi_arprot    , ``bus_name3``_axi_arprot    , ``bus_name2``_axi_arprot    , ``bus_name1``_axi_arprot    , ``bus_name0``_axi_arprot   }; \
    assign ``array_name``_axi_arqos    = {``bus_name10``_axi_arqos     , ``bus_name9``_axi_arqos     , ``bus_name8``_axi_arqos     , ``bus_name7``_axi_arqos     , ``bus_name6``_axi_arqos     , ``bus_name5``_axi_arqos     , ``bus_name4``_axi_arqos     , ``bus_name3``_axi_arqos     , ``bus_name2``_axi_arqos     , ``bus_name1``_axi_arqos     , ``bus_name0``_axi_arqos    }; \
    assign ``array_name``_axi_arvalid  = {``bus_name10``_axi_arvalid   , ``bus_name9``_axi_arvalid   , ``bus_name8``_axi_arvalid   , ``bus_name7``_axi_arvalid   , ``bus_name6``_axi_arvalid   , ``bus_name5``_axi_arvalid   , ``bus_name4``_axi_arvalid   , ``bus_name3``_axi_arvalid   , ``bus_name2``_axi_arvalid   , ``bus_name1``_axi_arvalid   , ``bus_name0``_axi_arvalid  }; \
    assign ``array_name``_axi_arid     = {``bus_name10``_axi_arid      , ``bus_name9``_axi_arid      , ``bus_name8``_axi_arid      , ``bus_name7``_axi_arid      , ``bus_name6``_axi_arid      , ``bus_name5``_axi_arid      , ``bus_name4``_axi_arid      , ``bus_name3``_axi_arid      , ``bus_name2``_axi_arid      , ``bus_name1``_axi_arid      , ``bus_name0``_axi_arid     }; \
    assign ``array_name``_axi_arregion = {``bus_name10``_axi_arregion  , ``bus_name9``_axi_arregion  , ``bus_name8``_axi_arregion  , ``bus_name7``_axi_arregion  , ``bus_name6``_axi_arregion  , ``bus_name5``_axi_arregion  , ``bus_name4``_axi_arregion  , ``bus_name3``_axi_arregion  , ``bus_name2``_axi_arregion  , ``bus_name1``_axi_arregion  , ``bus_name0``_axi_arregion }; \
    assign ``array_name``_axi_rready   = {``bus_name10``_axi_rready    , ``bus_name9``_axi_rready    , ``bus_name8``_axi_rready    , ``bus_name7``_axi_rready    , ``bus_name6``_axi_rready    , ``bus_name5``_axi_rready    , ``bus_name4``_axi_rready    , ``bus_name3``_axi_rready    , ``bus_name2``_axi_rready    , ``bus_name1``_axi_rready    , ``bus_name0``_axi_rready   }; \
    assign {``bus_name10``_axi_awready    , ``bus_name9``_axi_awready    , ``bus_name8``_axi_awready    , ``bus_name7``_axi_awready    , ``bus_name6``_axi_awready   , ``bus_name5``_axi_awready   , ``bus_name4``_axi_awready   , ``bus_name3``_axi_awready   , ``bus_name2``_axi_awready   , ``bus_name1``_axi_awready   , ``bus_name0``_axi_awready  } = ``array_name``_axi_awready ; \
    assign {``bus_name10``_axi_wready     , ``bus_name9``_axi_wready     , ``bus_name8``_axi_wready     , ``bus_name7``_axi_wready     , ``bus_name6``_axi_wready    , ``bus_name5``_axi_wready    , ``bus_name4``_axi_wready    , ``bus_name3``_axi_wready    , ``bus_name2``_axi_wready    , ``bus_name1``_axi_wready    , ``bus_name0``_axi_wready   } = ``array_name``_axi_wready  ; \
    assign {``bus_name10``_axi_bid        , ``bus_name9``_axi_bid        , ``bus_name8``_axi_bid        , ``bus_name7``_axi_bid        , ``bus_name6``_axi_bid       , ``bus_name5``_axi_bid       , ``bus_name4``_axi_bid       , ``bus_name3``_axi_bid       , ``bus_name2``_axi_bid       , ``bus_name1``_axi_bid       , ``bus_name0``_axi_bid      } = ``array_name``_axi_bid     ; \
    assign {``bus_name10``_axi_bresp      , ``bus_name9``_axi_bresp      , ``bus_name8``_axi_bresp      , ``bus_name7``_axi_bresp      , ``bus_name6``_axi_bresp     , ``bus_name5``_axi_bresp     , ``bus_name4``_axi_bresp     , ``bus_name3``_axi_bresp     , ``bus_name2``_axi_bresp     , ``bus_name1``_axi_bresp     , ``bus_name0``_axi_bresp    } = ``array_name``_axi_bresp   ; \
    assign {``bus_name10``_axi_bvalid     , ``bus_name9``_axi_bvalid     , ``bus_name8``_axi_bvalid     , ``bus_name7``_axi_bvalid     , ``bus_name6``_axi_bvalid    , ``bus_name5``_axi_bvalid    , ``bus_name4``_axi_bvalid    , ``bus_name3``_axi_bvalid    , ``bus_name2``_axi_bvalid    , ``bus_name1``_axi_bvalid    , ``bus_name0``_axi_bvalid   } = ``array_name``_axi_bvalid  ; \
    assign {``bus_name10``_axi_arready    , ``bus_name9``_axi_arready    , ``bus_name8``_axi_arready    , ``bus_name7``_axi_arready    , ``bus_name6``_axi_arready   , ``bus_name5``_axi_arready   , ``bus_name4``_axi_arready   , ``bus_name3``_axi_arready   , ``bus_name2``_axi_arready   , ``bus_name1``_axi_arready   , ``bus_name0``_axi_arready  } = ``array_name``_axi_arready ; \
    assign {``bus_name10``_axi_rid        , ``bus_name9``_axi_rid        , ``bus_name8``_axi_rid        , ``bus_name7``_axi_rid        , ``bus_name6``_axi_rid       , ``bus_name5``_axi_rid       , ``bus_name4``_axi_rid       , ``bus_name3``_axi_rid       , ``bus_name2``_axi_rid       , ``bus_name1``_axi_rid       , ``bus_name0``_axi_rid      } = ``array_name``_axi_rid     ; \
    assign {``bus_name10``_axi_rdata      , ``bus_name9``_axi_rdata      , ``bus_name8``_axi_rdata      , ``bus_name7``_axi_rdata      , ``bus_name6``_axi_rdata     , ``bus_name5``_axi_rdata     , ``bus_name4``_axi_rdata     , ``bus_name3``_axi_rdata     , ``bus_name2``_axi_rdata     , ``bus_name1``_axi_rdata     , ``bus_name0``_axi_rdata    } = ``array_name``_axi_rdata   ; \
    assign {``bus_name10``_axi_rresp      , ``bus_name9``_axi_rresp      , ``bus_name8``_axi_rresp      , ``bus_name7``_axi_rresp      , ``bus_name6``_axi_rresp     , ``bus_name5``_axi_rresp     , ``bus_name4``_axi_rresp     , ``bus_name3``_axi_rresp     , ``bus_name2``_axi_rresp     , ``bus_name1``_axi_rresp     , ``bus_name0``_axi_rresp    } = ``array_name``_axi_rresp   ; \
    assign {``bus_name10``_axi_rlast      , ``bus_name9``_axi_rlast      , ``bus_name8``_axi_rlast      , ``bus_name7``_axi_rlast      , ``bus_name6``_axi_rlast     , ``bus_name5``_axi_rlast     , ``bus_name4``_axi_rlast     , ``bus_name3``_axi_rlast     , ``bus_name2``_axi_rlast     , ``bus_name1``_axi_rlast     , ``bus_name0``_axi_rlast    } = ``array_name``_axi_rlast   ; \
    assign {``bus_name10``_axi_rvalid     , ``bus_name9``_axi_rvalid     , ``bus_name8``_axi_rvalid     , ``bus_name7``_axi_rvalid     , ``bus_name6``_axi_rvalid    , ``bus_name5``_axi_rvalid    , ``bus_name4``_axi_rvalid    , ``bus_name3``_axi_rvalid    , ``bus_name2``_axi_rvalid    , ``bus_name1``_axi_rvalid    , ``bus_name0``_axi_rvalid   } = ``array_name``_axi_rvalid  ;
...
// Concatenate 15 slave buses
`define CONCAT_AXI_MASTERS_ARRAY15(array_name, bus_name14, bus_name13, bus_name12, bus_name11, bus_name10, bus_name9, bus_name8, bus_name7, bus_name6, bus_name5, bus_name4, bus_name3, bus_name2, bus_name1, bus_name0) \
    assign ``array_name``_axi_awid     = {``bus_name14``_axi_awid      , ``bus_name13``_axi_awid      , ``bus_name12``_axi_awid      , ``bus_name11``_axi_awid      , ``bus_name10``_axi_awid      , ``bus_name9``_axi_awid      , ``bus_name8``_axi_awid      , ``bus_name7``_axi_awid      , ``bus_name6``_axi_awid      , ``bus_name5``_axi_awid      , ``bus_name4``_axi_awid      , ``bus_name3``_axi_awid      , ``bus_name2``_axi_awid      , ``bus_name1``_axi_awid      , ``bus_name0``_axi_awid     }; \
    assign ``array_name``_axi_awaddr   = {``bus_name14``_axi_awaddr    , ``bus_name13``_axi_awaddr    , ``bus_name12``_axi_awaddr    , ``bus_name11``_axi_awaddr    , ``bus_name10``_axi_awaddr    , ``bus_name9``_axi_awaddr    , ``bus_name8``_axi_awaddr    , ``bus_name7``_axi_awaddr    , ``bus_name6``_axi_awaddr    , ``bus_name5``_axi_awaddr    , ``bus_name4``_axi_awaddr    , ``bus_name3``_axi_awaddr    , ``bus_name2``_axi_awaddr    , ``bus_name1``_axi_awaddr    , ``bus_name0``_axi_awaddr   }; \
    assign ``array_name``_axi_awlen    = {``bus_name14``_axi_awlen     , ``bus_name13``_axi_awlen     , ``bus_name12``_axi_awlen     , ``bus_name11``_axi_awlen     , ``bus_name10``_axi_awlen     , ``bus_name9``_axi_awlen     , ``bus_name8``_axi_awlen     , ``bus_name7``_axi_awlen     , ``bus_name6``_axi_awlen     , ``bus_name5``_axi_awlen     , ``bus_name4``_axi_awlen     , ``bus_name3``_axi_awlen     , ``bus_name2``_axi_awlen     , ``bus_name1``_axi_awlen     , ``bus_name0``_axi_awlen    }; \
    assign ``array_name``_axi_awsize   = {``bus_name14``_axi_awsize    , ``bus_name13``_axi_awsize    , ``bus_name12``_axi_awsize    , ``bus_name11``_axi_awsize    , ``bus_name10``_axi_awsize    , ``bus_name9``_axi_awsize    , ``bus_name8``_axi_awsize    , ``bus_name7``_axi_awsize    , ``bus_name6``_axi_awsize    , ``bus_name5``_axi_awsize    , ``bus_name4``_axi_awsize    , ``bus_name3``_axi_awsize    , ``bus_name2``_axi_awsize    , ``bus_name1``_axi_awsize    , ``bus_name0``_axi_awsize   }; \
    assign ``array_name``_axi_awburst  = {``bus_name14``_axi_awburst   , ``bus_name13``_axi_awburst   , ``bus_name12``_axi_awburst   , ``bus_name11``_axi_awburst   , ``bus_name10``_axi_awburst   , ``bus_name9``_axi_awburst   , ``bus_name8``_axi_awburst   , ``bus_name7``_axi_awburst   , ``bus_name6``_axi_awburst   , ``bus_name5``_axi_awburst   , ``bus_name4``_axi_awburst   , ``bus_name3``_axi_awburst   , ``bus_name2``_axi_awburst   , ``bus_name1``_axi_awburst   , ``bus_name0``_axi_awburst  }; \
    assign ``array_name``_axi_awlock   = {``bus_name14``_axi_awlock    , ``bus_name13``_axi_awlock    , ``bus_name12``_axi_awlock    , ``bus_name11``_axi_awlock    , ``bus_name10``_axi_awlock    , ``bus_name9``_axi_awlock    , ``bus_name8``_axi_awlock    , ``bus_name7``_axi_awlock    , ``bus_name6``_axi_awlock    , ``bus_name5``_axi_awlock    , ``bus_name4``_axi_awlock    , ``bus_name3``_axi_awlock    , ``bus_name2``_axi_awlock    , ``bus_name1``_axi_awlock    , ``bus_name0``_axi_awlock   }; \
    assign ``array_name``_axi_awcache  = {``bus_name14``_axi_awcache   , ``bus_name13``_axi_awcache   , ``bus_name12``_axi_awcache   , ``bus_name11``_axi_awcache   , ``bus_name10``_axi_awcache   , ``bus_name9``_axi_awcache   , ``bus_name8``_axi_awcache   , ``bus_name7``_axi_awcache   , ``bus_name6``_axi_awcache   , ``bus_name5``_axi_awcache   , ``bus_name4``_axi_awcache   , ``bus_name3``_axi_awcache   , ``bus_name2``_axi_awcache   , ``bus_name1``_axi_awcache   , ``bus_name0``_axi_awcache  }; \
    assign ``array_name``_axi_awprot   = {``bus_name14``_axi_awprot    , ``bus_name13``_axi_awprot    , ``bus_name12``_axi_awprot    , ``bus_name11``_axi_awprot    , ``bus_name10``_axi_awprot    , ``bus_name9``_axi_awprot    , ``bus_name8``_axi_awprot    , ``bus_name7``_axi_awprot    , ``bus_name6``_axi_awprot    , ``bus_name5``_axi_awprot    , ``bus_name4``_axi_awprot    , ``bus_name3``_axi_awprot    , ``bus_name2``_axi_awprot    , ``bus_name1``_axi_awprot    , ``bus_name0``_axi_awprot   }; \
    assign ``array_name``_axi_awqos    = {``bus_name14``_axi_awqos     , ``bus_name13``_axi_awqos     , ``bus_name12``_axi_awqos     , ``bus_name11``_axi_awqos     , ``bus_name10``_axi_awqos     , ``bus_name9``_axi_awqos     , ``bus_name8``_axi_awqos     , ``bus_name7``_axi_awqos     , ``bus_name6``_axi_awqos     , ``bus_name5``_axi_awqos     , ``bus_name4``_axi_awqos     , ``bus_name3``_axi_awqos     , ``bus_name2``_axi_awqos     , ``bus_name1``_axi_awqos     , ``bus_name0``_axi_awqos    }; \
    assign ``array_name``_axi_awvalid  = {``bus_name14``_axi_awvalid   , ``bus_name13``_axi_awvalid   , ``bus_name12``_axi_awvalid   , ``bus_name11``_axi_awvalid   , ``bus_name10``_axi_awvalid   , ``bus_name9``_axi_awvalid   , ``bus_name8``_axi_awvalid   , ``bus_name7``_axi_awvalid   , ``bus_name6``_axi_awvalid   , ``bus_name5``_axi_awvalid   , ``bus_name4``_axi_awvalid   , ``bus_name3``_axi_awvalid   , ``bus_name2``_axi_awvalid   , ``bus_name1``_axi_awvalid   , ``bus_name0``_axi_awvalid  }; \
    assign ``array_name``_axi_awregion = {``bus_name14``_axi_awregion  , ``bus_name13``_axi_awregion  , ``bus_name12``_axi_awregion  , ``bus_name11``_axi_awregion  , ``bus_name10``_axi_awregion  , ``bus_name9``_axi_awregion  , ``bus_name8``_axi_awregion  , ``bus_name7``_axi_awregion  , ``bus_name6``_axi_awregion  , ``bus_name5``_axi_awregion  , ``bus_name4``_axi_awregion  , ``bus_name3``_axi_awregion  , ``bus_name2``_axi_awregion  , ``bus_name1``_axi_awregion  , ``bus_name0``_axi_awregion }; \
    assign ``array_name``_axi_wdata    = {``bus_name14``_axi_wdata     , ``bus_name13``_axi_wdata     , ``bus_name12``_axi_wdata     , ``bus_name11``_axi_wdata     , ``bus_name10``_axi_wdata     , ``bus_name9``_axi_wdata     , ``bus_name8``_axi_wdata     , ``bus_name7``_axi_wdata     , ``bus_name6``_axi_wdata     , ``bus_name5``_axi_wdata     , ``bus_name4``_axi_wdata     , ``bus_name3``_axi_wdata     , ``bus_name2``_axi_wdata     , ``bus_name1``_axi_wdata     , ``bus_name0``_axi_wdata    }; \
    assign ``array_name``_axi_wstrb    = {``bus_name14``_axi_wstrb     , ``bus_name13``_axi_wstrb     , ``bus_name12``_axi_wstrb     , ``bus_name11``_axi_wstrb     , ``bus_name10``_axi_wstrb     , ``bus_name9``_axi_wstrb     , ``bus_name8``_axi_wstrb     , ``bus_name7``_axi_wstrb     , ``bus_name6``_axi_wstrb     , ``bus_name5``_axi_wstrb     , ``bus_name4``_axi_wstrb     , ``bus_name3``_axi_wstrb     , ``bus_name2``_axi_wstrb     , ``bus_name1``_axi_wstrb     , ``bus_name0``_axi_wstrb    }; \
    assign ``array_name``_axi_wlast    = {``bus_name14``_axi_wlast     , ``bus_name13``_axi_wlast     , ``bus_name12``_axi_wlast     , ``bus_name11``_axi_wlast     , ``bus_name10``_axi_wlast     , ``bus_name9``_axi_wlast     , ``bus_name8``_axi_wlast     , ``bus_name7``_axi_wlast     , ``bus_name6``_axi_wlast     , ``bus_name5``_axi_wlast     , ``bus_name4``_axi_wlast     , ``bus_name3``_axi_wlast     , ``bus_name2``_axi_wlast     , ``bus_name1``_axi_wlast     , ``bus_name0``_axi_wlast    }; \
    assign ``array_name``_axi_wvalid   = {``bus_name14``_axi_wvalid    , ``bus_name13``_axi_wvalid    , ``bus_name12``_axi_wvalid    , ``bus_name11``_axi_wvalid    , ``bus_name10``_axi_wvalid    , ``bus_name9``_axi_wvalid    , ``bus_name8``_axi_wvalid    , ``bus_name7``_axi_wvalid    , ``bus_name6``_axi_wvalid    , ``bus_name5``_axi_wvalid    , ``bus_name4``_axi_wvalid    , ``bus_name3``_axi_wvalid    , ``bus_name2``_axi_wvalid    , ``bus_name1``_axi_wvalid    , ``bus_name0``_axi_wvalid   }; \
    assign ``array_name``_axi_bready   = {``bus_name14``_axi_bready    , ``bus_name13``_axi_bready    , ``bus_name12``_axi_bready    , ``bus_name11``_axi_bready    , ``bus_name10``_axi_bready    , ``bus_name9``_axi_bready    , ``bus_name8``_axi_bready    , ``bus_name7``_axi_bready    , ``bus_name6``_axi_bready    , ``bus_name5``_axi_bready    , ``bus_name4``_axi_bready    , ``bus_name3``_axi_bready    , ``bus_name2``_axi_bready    , ``bus_name1``_axi_bready    , ``bus_name0``_axi_bready   }; \
    assign ``array_name``_axi_araddr   = {``bus_name14``_axi_araddr    , ``bus_name13``_axi_araddr    , ``bus_name12``_axi_araddr    , ``bus_name11``_axi_araddr    , ``bus_name10``_axi_araddr    , ``bus_name9``_axi_araddr    , ``bus_name8``_axi_araddr    , ``bus_name7``_axi_araddr    , ``bus_name6``_axi_araddr    , ``bus_name5``_axi_araddr    , ``bus_name4``_axi_araddr    , ``bus_name3``_axi_araddr    , ``bus_name2``_axi_araddr    , ``bus_name1``_axi_araddr    , ``bus_name0``_axi_araddr   }; \
    assign ``array_name``_axi_arlen    = {``bus_name14``_axi_arlen     , ``bus_name13``_axi_arlen     , ``bus_name12``_axi_arlen     , ``bus_name11``_axi_arlen     , ``bus_name10``_axi_arlen     , ``bus_name9``_axi_arlen     , ``bus_name8``_axi_arlen     , ``bus_name7``_axi_arlen     , ``bus_name6``_axi_arlen     , ``bus_name5``_axi_arlen     , ``bus_name4``_axi_arlen     , ``bus_name3``_axi_arlen     , ``bus_name2``_axi_arlen     , ``bus_name1``_axi_arlen     , ``bus_name0``_axi_arlen    }; \
    assign ``array_name``_axi_arsize   = {``bus_name14``_axi_arsize    , ``bus_name13``_axi_arsize    , ``bus_name12``_axi_arsize    , ``bus_name11``_axi_arsize    , ``bus_name10``_axi_arsize    , ``bus_name9``_axi_arsize    , ``bus_name8``_axi_arsize    , ``bus_name7``_axi_arsize    , ``bus_name6``_axi_arsize    , ``bus_name5``_axi_arsize    , ``bus_name4``_axi_arsize    , ``bus_name3``_axi_arsize    , ``bus_name2``_axi_arsize    , ``bus_name1``_axi_arsize    , ``bus_name0``_axi_arsize   }; \
    assign ``array_name``_axi_arburst  = {``bus_name14``_axi_arburst   , ``bus_name13``_axi_arburst   , ``bus_name12``_axi_arburst   , ``bus_name11``_axi_arburst   , ``bus_name10``_axi_arburst   , ``bus_name9``_axi_arburst   , ``bus_name8``_axi_arburst   , ``bus_name7``_axi_arburst   , ``bus_name6``_axi_arburst   , ``bus_name5``_axi_arburst   , ``bus_name4``_axi_arburst   , ``bus_name3``_axi_arburst   , ``bus_name2``_axi_arburst   , ``bus_name1``_axi_arburst   , ``bus_name0``_axi_arburst  }; \
    assign ``array_name``_axi_arlock   = {``bus_name14``_axi_arlock    , ``bus_name13``_axi_arlock    , ``bus_name12``_axi_arlock    , ``bus_name11``_axi_arlock    , ``bus_name10``_axi_arlock    , ``bus_name9``_axi_arlock    , ``bus_name8``_axi_arlock    , ``bus_name7``_axi_arlock    , ``bus_name6``_axi_arlock    , ``bus_name5``_axi_arlock    , ``bus_name4``_axi_arlock    , ``bus_name3``_axi_arlock    , ``bus_name2``_axi_arlock    , ``bus_name1``_axi_arlock    , ``bus_name0``_axi_arlock   }; \
    assign ``array_name``_axi_arcache  = {``bus_name14``_axi_arcache   , ``bus_name13``_axi_arcache   , ``bus_name12``_axi_arcache   , ``bus_name11``_axi_arcache   , ``bus_name10``_axi_arcache   , ``bus_name9``_axi_arcache   , ``bus_name8``_axi_arcache   , ``bus_name7``_axi_arcache   , ``bus_name6``_axi_arcache   , ``bus_name5``_axi_arcache   , ``bus_name4``_axi_arcache   , ``bus_name3``_axi_arcache   , ``bus_name2``_axi_arcache   , ``bus_name1``_axi_arcache   , ``bus_name0``_axi_arcache  }; \
    assign ``array_name``_axi_arprot   = {``bus_name14``_axi_arprot    , ``bus_name13``_axi_arprot    , ``bus_name12``_axi_arprot    , ``bus_name11``_axi_arprot    , ``bus_name10``_axi_arprot    , ``bus_name9``_axi_arprot    , ``bus_name8``_axi_arprot    , ``bus_name7``_axi_arprot    , ``bus_name6``_axi_arprot    , ``bus_name5``_axi_arprot    , ``bus_name4``_axi_arprot    , ``bus_name3``_axi_arprot    , ``bus_name2``_axi_arprot    , ``bus_name1``_axi_arprot    , ``bus_name0``_axi_arprot   }; \
    assign ``array_name``_axi_arqos    = {``bus_name14``_axi_arqos     , ``bus_name13``_axi_arqos     , ``bus_name12``_axi_arqos     , ``bus_name11``_axi_arqos     , ``bus_name10``_axi_arqos     , ``bus_name9``_axi_arqos     , ``bus_name8``_axi_arqos     , ``bus_name7``_axi_arqos     , ``bus_name6``_axi_arqos     , ``bus_name5``_axi_arqos     , ``bus_name4``_axi_arqos     , ``bus_name3``_axi_arqos     , ``bus_name2``_axi_arqos     , ``bus_name1``_axi_arqos     , ``bus_name0``_axi_arqos    }; \
    assign ``array_name``_axi_arvalid  = {``bus_name14``_axi_arvalid   , ``bus_name13``_axi_arvalid   , ``bus_name12``_axi_arvalid   , ``bus_name11``_axi_arvalid   , ``bus_name10``_axi_arvalid   , ``bus_name9``_axi_arvalid   , ``bus_name8``_axi_arvalid   , ``bus_name7``_axi_arvalid   , ``bus_name6``_axi_arvalid   , ``bus_name5``_axi_arvalid   , ``bus_name4``_axi_arvalid   , ``bus_name3``_axi_arvalid   , ``bus_name2``_axi_arvalid   , ``bus_name1``_axi_arvalid   , ``bus_name0``_axi_arvalid  }; \
    assign ``array_name``_axi_arid     = {``bus_name14``_axi_arid      , ``bus_name13``_axi_arid      , ``bus_name12``_axi_arid      , ``bus_name11``_axi_arid      , ``bus_name10``_axi_arid      , ``bus_name9``_axi_arid      , ``bus_name8``_axi_arid      , ``bus_name7``_axi_arid      , ``bus_name6``_axi_arid      , ``bus_name5``_axi_arid      , ``bus_name4``_axi_arid      , ``bus_name3``_axi_arid      , ``bus_name2``_axi_arid      , ``bus_name1``_axi_arid      , ``bus_name0``_axi_arid     }; \
    assign ``array_name``_axi_arregion = {``bus_name14``_axi_arregion  , ``bus_name13``_axi_arregion  , ``bus_name12``_axi_arregion  , ``bus_name11``_axi_arregion  , ``bus_name10``_axi_arregion  , ``bus_name9``_axi_arregion  , ``bus_name8``_axi_arregion  , ``bus_name7``_axi_arregion  , ``bus_name6``_axi_arregion  , ``bus_name5``_axi_arregion  , ``bus_name4``_axi_arregion  , ``bus_name3``_axi_arregion  , ``bus_name2``_axi_arregion  , ``bus_name1``_axi_arregion  , ``bus_name0``_axi_arregion }; \
    assign ``array_name``_axi_rready   = {``bus_name14``_axi_rready    , ``bus_name13``_axi_rready    , ``bus_name12``_axi_rready    , ``bus_name11``_axi_rready    , ``bus_name10``_axi_rready    , ``bus_name9``_axi_rready    , ``bus_name8``_axi_rready    , ``bus_name7``_axi_rready    , ``bus_name6``_axi_rready    , ``bus_name5``_axi_rready    , ``bus_name4``_axi_rready    , ``bus_name3``_axi_rready    , ``bus_name2``_axi_rready    , ``bus_name1``_axi_rready    , ``bus_name0``_axi_rready   }; \
    assign {``bus_name14``_axi_awready    , ``bus_name13``_axi_awready    , ``bus_name12``_axi_awready    , ``bus_name11``_axi_awready    , ``bus_name10``_axi_awready   , ``bus_name9``_axi_awready   , ``bus_name8``_axi_awready   , ``bus_name7``_axi_awready   , ``bus_name6``_axi_awready   , ``bus_name5``_axi_awready   , ``bus_name4``_axi_awready   , ``bus_name3``_axi_awready   , ``bus_name2``_axi_awready   , ``bus_name1``_axi_awready   , ``bus_name0``_axi_awready  } = ``array_name``_axi_awready ; \
    assign {``bus_name14``_axi_wready     , ``bus_name13``_axi_wready     , ``bus_name12``_axi_wready     , ``bus_name11``_axi_wready     , ``bus_name10``_axi_wready    , ``bus_name9``_axi_wready    , ``bus_name8``_axi_wready    , ``bus_name7``_axi_wready    , ``bus_name6``_axi_wready    , ``bus_name5``_axi_wready    , ``bus_name4``_axi_wready    , ``bus_name3``_axi_wready    , ``bus_name2``_axi_wready    , ``bus_name1``_axi_wready    , ``bus_name0``_axi_wready   } = ``array_name``_axi_wready  ; \
    assign {``bus_name14``_axi_bid        , ``bus_name13``_axi_bid        , ``bus_name12``_axi_bid        , ``bus_name11``_axi_bid        , ``bus_name10``_axi_bid       , ``bus_name9``_axi_bid       , ``bus_name8``_axi_bid       , ``bus_name7``_axi_bid       , ``bus_name6``_axi_bid       , ``bus_name5``_axi_bid       , ``bus_name4``_axi_bid       , ``bus_name3``_axi_bid       , ``bus_name2``_axi_bid       , ``bus_name1``_axi_bid       , ``bus_name0``_axi_bid      } = ``array_name``_axi_bid     ; \
    assign {``bus_name14``_axi_bresp      , ``bus_name13``_axi_bresp      , ``bus_name12``_axi_bresp      , ``bus_name11``_axi_bresp      , ``bus_name10``_axi_bresp     , ``bus_name9``_axi_bresp     , ``bus_name8``_axi_bresp     , ``bus_name7``_axi_bresp     , ``bus_name6``_axi_bresp     , ``bus_name5``_axi_bresp     , ``bus_name4``_axi_bresp     , ``bus_name3``_axi_bresp     , ``bus_name2``_axi_bresp     , ``bus_name1``_axi_bresp     , ``bus_name0``_axi_bresp    } = ``array_name``_axi_bresp   ; \
    assign {``bus_name14``_axi_bvalid     , ``bus_name13``_axi_bvalid     , ``bus_name12``_axi_bvalid     , ``bus_name11``_axi_bvalid    , ``bus_name10``_axi_bvalid    , ``bus_name9``_axi_bvalid    , ``bus_name8``_axi_bvalid    , ``bus_name7``_axi_bvalid    , ``bus_name6``_axi_bvalid    , ``bus_name5``_axi_bvalid    , ``bus_name4``_axi_bvalid    , ``bus_name3``_axi_bvalid    , ``bus_name2``_axi_bvalid    , ``bus_name1``_axi_bvalid    , ``bus_name0``_axi_bvalid   } = ``array_name``_axi_bvalid  ; \
    assign {``bus_name14``_axi_arready    , ``bus_name13``_axi_arready    , ``bus_name12``_axi_arready    , ``bus_name11``_axi_arready    , ``bus_name10``_axi_arready   , ``bus_name9``_axi_arready   , ``bus_name8``_axi_arready   , ``bus_name7``_axi_arready   , ``bus_name6``_axi_arready   , ``bus_name5``_axi_arready   , ``bus_name4``_axi_arready   , ``bus_name3``_axi_arready   , ``bus_name2``_axi_arready   , ``bus_name1``_axi_arready   , ``bus_name0``_axi_arready  } = ``array_name``_axi_arready ; \
    assign {``bus_name14``_axi_rid        , ``bus_name13``_axi_rid        , ``bus_name12``_axi_rid        , ``bus_name11``_axi_rid        , ``bus_name10``_axi_rid       , ``bus_name9``_axi_rid       , ``bus_name8``_axi_rid       , ``bus_name7``_axi_rid       , ``bus_name6``_axi_rid       , ``bus_name5``_axi_rid       , ``bus_name4``_axi_rid       , ``bus_name3``_axi_rid       , ``bus_name2``_axi_rid       , ``bus_name1``_axi_rid       , ``bus_name0``_axi_rid      } = ``array_name``_axi_rid     ; \
    assign {``bus_name14``_axi_rdata      , ``bus_name13``_axi_rdata      , ``bus_name12``_axi_rdata      , ``bus_name11``_axi_rdata      , ``bus_name10``_axi_rdata     , ``bus_name9``_axi_rdata     , ``bus_name8``_axi_rdata     , ``bus_name7``_axi_rdata     , ``bus_name6``_axi_rdata     , ``bus_name5``_axi_rdata     , ``bus_name4``_axi_rdata     , ``bus_name3``_axi_rdata     , ``bus_name2``_axi_rdata     , ``bus_name1``_axi_rdata     , ``bus_name0``_axi_rdata    } = ``array_name``_axi_rdata   ; \
    assign {``bus_name14``_axi_rresp      , ``bus_name13``_axi_rresp      , ``bus_name12``_axi_rresp      , ``bus_name11``_axi_rresp      , ``bus_name10``_axi_rresp     , ``bus_name9``_axi_rresp     , ``bus_name8``_axi_rresp     , ``bus_name7``_axi_rresp     , ``bus_name6``_axi_rresp     , ``bus_name5``_axi_rresp     , ``bus_name4``_axi_rresp     , ``bus_name3``_axi_rresp     , ``bus_name2``_axi_rresp     , ``bus_name1``_axi_rresp     , ``bus_name0``_axi_rresp    } = ``array_name``_axi_rresp   ; \
    assign {``bus_name14``_axi_rlast      , ``bus_name13``_axi_rlast      , ``bus_name12``_axi_rlast      , ``bus_name11``_axi_rlast      , ``bus_name10``_axi_rlast     , ``bus_name9``_axi_rlast     , ``bus_name8``_axi_rlast     , ``bus_name7``_axi_rlast     , ``bus_name6``_axi_rlast     , ``bus_name5``_axi_rlast     , ``bus_name4``_axi_rlast     , ``bus_name3``_axi_rlast     , ``bus_name2``_axi_rlast     , ``bus_name1``_axi_rlast     , ``bus_name0``_axi_rlast    } = ``array_name``_axi_rlast   ; \
    assign {``bus_name14``_axi_rvalid     , ``bus_name13``_axi_rvalid     , ``bus_name12``_axi_rvalid     , ``bus_name11``_axi_rvalid    , ``bus_name10``_axi_rvalid    , ``bus_name9``_axi_rvalid    , ``bus_name8``_axi_rvalid    , ``bus_name7``_axi_rvalid    , ``bus_name6``_axi_rvalid    , ``bus_name5``_axi_rvalid    , ``bus_name4``_axi_rvalid    , ``bus_name3``_axi_rvalid    , ``bus_name2``_axi_rvalid    , ``bus_name1``_axi_rvalid    , ``bus_name0``_axi_rvalid   } = ``array_name``_axi_rvalid  ;
