...
module highperformance_bus #(
    ...
    xlnx_ddr4_mig ddr4_mig_u (
        ...
        // AXI4 interface
        .c0_ddr4_s_axi_awid          ( HBUS_to_DDR4CH_0_axi_awid    ),
        .c0_ddr4_s_axi_awaddr        ( { 2'b00, HBUS_to_DDR4CH_0_axi_awaddr } ), // 34 bits
        .c0_ddr4_s_axi_awlen         ( HBUS_to_DDR4CH_0_axi_awlen   ),
        .c0_ddr4_s_axi_awsize        ( HBUS_to_DDR4CH_0_axi_awsize  ),
        .c0_ddr4_s_axi_awburst       ( HBUS_to_DDR4CH_0_axi_awburst ),
        .c0_ddr4_s_axi_awlock        ( HBUS_to_DDR4CH_0_axi_awlock  ),
        .c0_ddr4_s_axi_awcache       ( HBUS_to_DDR4CH_0_axi_awcache ),
        .c0_ddr4_s_axi_awprot        ( HBUS_to_DDR4CH_0_axi_awprot  ),
        .c0_ddr4_s_axi_awqos         ( HBUS_to_DDR4CH_0_axi_awqos   ),
        .c0_ddr4_s_axi_awvalid       ( HBUS_to_DDR4CH_0_axi_awvalid ),
        .c0_ddr4_s_axi_awready       ( HBUS_to_DDR4CH_0_axi_awready ),
        .c0_ddr4_s_axi_wdata         ( HBUS_to_DDR4CH_0_axi_wdata   ),
        .c0_ddr4_s_axi_wstrb         ( HBUS_to_DDR4CH_0_axi_wstrb   ),
        .c0_ddr4_s_axi_wlast         ( HBUS_to_DDR4CH_0_axi_wlast   ),
        .c0_ddr4_s_axi_wvalid        ( HBUS_to_DDR4CH_0_axi_wvalid  ),
        .c0_ddr4_s_axi_wready        ( HBUS_to_DDR4CH_0_axi_wready  ),
        .c0_ddr4_s_axi_bready        ( HBUS_to_DDR4CH_0_axi_bready  ),
        .c0_ddr4_s_axi_bid           ( HBUS_to_DDR4CH_0_axi_bid     ),
        .c0_ddr4_s_axi_bresp         ( HBUS_to_DDR4CH_0_axi_bresp   ),
        .c0_ddr4_s_axi_bvalid        ( HBUS_to_DDR4CH_0_axi_bvalid  ),
        .c0_ddr4_s_axi_arid          ( HBUS_to_DDR4CH_0_axi_arid    ),
        .c0_ddr4_s_axi_araddr        ( { 2'b00, HBUS_to_DDR4CH_0_axi_araddr } ), // 34 bits
        .c0_ddr4_s_axi_arlen         ( HBUS_to_DDR4CH_0_axi_arlen   ),
        .c0_ddr4_s_axi_arsize        ( HBUS_to_DDR4CH_0_axi_arsize  ),
        .c0_ddr4_s_axi_arburst       ( HBUS_to_DDR4CH_0_axi_arburst ),
        .c0_ddr4_s_axi_arlock        ( HBUS_to_DDR4CH_0_axi_arlock  ),
        .c0_ddr4_s_axi_arcache       ( HBUS_to_DDR4CH_0_axi_arcache ),
        .c0_ddr4_s_axi_arprot        ( HBUS_to_DDR4CH_0_axi_arprot  ),
        .c0_ddr4_s_axi_arqos         ( HBUS_to_DDR4CH_0_axi_arqos   ),
        .c0_ddr4_s_axi_arvalid       ( HBUS_to_DDR4CH_0_axi_arvalid ),
        .c0_ddr4_s_axi_arready       ( HBUS_to_DDR4CH_0_axi_arready ),
        .c0_ddr4_s_axi_rready        ( HBUS_to_DDR4CH_0_axi_rready  ),
        .c0_ddr4_s_axi_rlast         ( HBUS_to_DDR4CH_0_axi_rlast   ),
        .c0_ddr4_s_axi_rvalid        ( HBUS_to_DDR4CH_0_axi_rvalid  ),
        .c0_ddr4_s_axi_rresp         ( HBUS_to_DDR4CH_0_axi_rresp   ),
        .c0_ddr4_s_axi_rid           ( HBUS_to_DDR4CH_0_axi_rid     ),
        .c0_ddr4_s_axi_rdata         ( HBUS_to_DDR4CH_0_axi_rdata   )
    );
