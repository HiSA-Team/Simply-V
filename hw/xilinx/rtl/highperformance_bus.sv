...
module highperformance_bus #(
    ...
    xlnx_ddr4 ddr4_u (
        ...
        // AXI4 interface
        .c0_ddr4_s_axi_awid          ( MBUS_to_DDR4CH0_axi_awid    ),
        .c0_ddr4_s_axi_awaddr        ( { 2'b00, MBUS_to_DDR4CH0_axi_awaddr } ), // 34 bits
        .c0_ddr4_s_axi_awlen         ( MBUS_to_DDR4CH0_axi_awlen   ),
        .c0_ddr4_s_axi_awsize        ( MBUS_to_DDR4CH0_axi_awsize  ),
        .c0_ddr4_s_axi_awburst       ( MBUS_to_DDR4CH0_axi_awburst ),
        .c0_ddr4_s_axi_awlock        ( MBUS_to_DDR4CH0_axi_awlock  ),
        .c0_ddr4_s_axi_awcache       ( MBUS_to_DDR4CH0_axi_awcache ),
        .c0_ddr4_s_axi_awprot        ( MBUS_to_DDR4CH0_axi_awprot  ),
        .c0_ddr4_s_axi_awqos         ( MBUS_to_DDR4CH0_axi_awqos   ),
        .c0_ddr4_s_axi_awvalid       ( MBUS_to_DDR4CH0_axi_awvalid ),
        .c0_ddr4_s_axi_awready       ( MBUS_to_DDR4CH0_axi_awready ),
        .c0_ddr4_s_axi_wdata         ( MBUS_to_DDR4CH0_axi_wdata   ),
        .c0_ddr4_s_axi_wstrb         ( MBUS_to_DDR4CH0_axi_wstrb   ),
        .c0_ddr4_s_axi_wlast         ( MBUS_to_DDR4CH0_axi_wlast   ),
        .c0_ddr4_s_axi_wvalid        ( MBUS_to_DDR4CH0_axi_wvalid  ),
        .c0_ddr4_s_axi_wready        ( MBUS_to_DDR4CH0_axi_wready  ),
        .c0_ddr4_s_axi_bready        ( MBUS_to_DDR4CH0_axi_bready  ),
        .c0_ddr4_s_axi_bid           ( MBUS_to_DDR4CH0_axi_bid     ),
        .c0_ddr4_s_axi_bresp         ( MBUS_to_DDR4CH0_axi_bresp   ),
        .c0_ddr4_s_axi_bvalid        ( MBUS_to_DDR4CH0_axi_bvalid  ),
        .c0_ddr4_s_axi_arid          ( MBUS_to_DDR4CH0_axi_arid    ),
        .c0_ddr4_s_axi_araddr        ( { 2'b00, MBUS_to_DDR4CH0_axi_araddr } ), // 34 bits
        .c0_ddr4_s_axi_arlen         ( MBUS_to_DDR4CH0_axi_arlen   ),
        .c0_ddr4_s_axi_arsize        ( MBUS_to_DDR4CH0_axi_arsize  ),
        .c0_ddr4_s_axi_arburst       ( MBUS_to_DDR4CH0_axi_arburst ),
        .c0_ddr4_s_axi_arlock        ( MBUS_to_DDR4CH0_axi_arlock  ),
        .c0_ddr4_s_axi_arcache       ( MBUS_to_DDR4CH0_axi_arcache ),
        .c0_ddr4_s_axi_arprot        ( MBUS_to_DDR4CH0_axi_arprot  ),
        .c0_ddr4_s_axi_arqos         ( MBUS_to_DDR4CH0_axi_arqos   ),
        .c0_ddr4_s_axi_arvalid       ( MBUS_to_DDR4CH0_axi_arvalid ),
        .c0_ddr4_s_axi_arready       ( MBUS_to_DDR4CH0_axi_arready ),
        .c0_ddr4_s_axi_rready        ( MBUS_to_DDR4CH0_axi_rready  ),
        .c0_ddr4_s_axi_rlast         ( MBUS_to_DDR4CH0_axi_rlast   ),
        .c0_ddr4_s_axi_rvalid        ( MBUS_to_DDR4CH0_axi_rvalid  ),
        .c0_ddr4_s_axi_rresp         ( MBUS_to_DDR4CH0_axi_rresp   ),
        .c0_ddr4_s_axi_rid           ( MBUS_to_DDR4CH0_axi_rid     ),
        .c0_ddr4_s_axi_rdata         ( MBUS_to_DDR4CH0_axi_rdata   )
    );
