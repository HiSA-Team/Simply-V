...
# "#define DEVICE_NAME.IS_ENABLED 1"
def create_uninasoc_render_devices(devices: list) -> str:
    lines = []
...
def create_uninasoc_render_peripherals(peripherals: list) -> str:
    lines = []
...
if __name__ == "__main__":
    ...
    rendered = hal_template_str.format(
        ...
        peripheral_block=create_uninasoc_render_peripherals(peripherals),
        include_guard=include_guard,
        device_block=create_uninasoc_render_devices(devices),
    )
