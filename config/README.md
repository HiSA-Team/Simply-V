...
1. **Config checking**
    ...
    configuration flows) starts with [`mbus.init_configurations()`](simply_config/buses/mbus.py#L42) that is the starting point for the creation of the
...
2. **Software configuration flow (`config_sw`)**
   ...
   - The software Makefile is generated by [`simplyv.update_sw_makefile()`](simply_config/general/simplyv.py#L138).
...
3. **Xilinx-related configuration**
   ...
   - [`simplyv.config_xilinx_makefile()`](simply_config/general/simplyv.py#L181)
   - [`simplyv.config_xilinx_clock_domains()`](simply_config/general/simplyv.py#L223)
   - [`simplyv.config_peripherals_ips()`](simply_config/general/simplyv.py#L251)
